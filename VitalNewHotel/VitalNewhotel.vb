...
Public Class VitalNewHotel
    ...
    Private mParaSecc_DepSuplementoDesayuno As String
    Private mCtaDebeCaja As String
    Private mCtaHaberCaja As String
    Private mForeCodiEfectivo As String
...
#Region "CONSTRUCTOR"
    ...
    ByVal vCuentaOpeCaja As String)
        ...
        Me.BorraRegistros()
        Me.CrearFichero(Me.mParaFilePath & Me.mParaFileName)
...
#Region "METODOS Privados"
    ...
    Private Sub CargaParametros()
        Try
            ...
            SQL += "PARA_VITAL_SUPLEDESAYUNO  ,"
            SQL += "PARA_VITAL_DEBECAJA  ,"
            SQL += "PARA_VITAL_HABERCAJA, "
            SQL += "PARA_VITAL_FOREEFECTIVO "
            ...
            If Me.DbLeeCentral.mDbLector.Read Then
                ...
                Me.mParaSecc_DepSuplementoDesayuno = CType(Me.DbLeeCentral.mDbLector.Item("PARA_VITAL_SUPLEDESAYUNO"), String)

                Me.mCtaDebeCaja = CType(Me.DbLeeCentral.mDbLector.Item("PARA_VITAL_DEBECAJA"), String)
                Me.mCtaHaberCaja = CType(Me.DbLeeCentral.mDbLector.Item("PARA_VITAL_HABERCAJA"), String)

                Me.mForeCodiEfectivo = CType(Me.DbLeeCentral.mDbLector.Item("PARA_VITAL_FOREEFECTIVO"), String)
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
        ...
        Try
            ...
            SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
            SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
            SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE,ASNT_AUXILIAR_STRING,ASNT_AUXILIAR_STRING2,ASNT_LIN_VLIQ,ASNT_LIN_TIIMP,ASNT_TIPO_IMPUESTO) values ('"
            SQL += vTipo & "','"
            SQL += vEmpGrupoCod & "','"
            SQL += vEmpCod & "','"
            SQL += vCefejerc_Cod & "','"
            ...
            & vTipoNota & "','" & vFacturaqueAnula & "'," & vBase & "," & vTipoIgic & "," & vTipoIgic & ")"
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
        ...
        Try
            ...
            SQL += vCosto & "','" & vServDesc & "','" & vTipoVenta & "','" & vSeccion & "','" & vCosto & "')"
    ...
    Private Sub InsertaOracleGustavo(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
        ...
        Try
            ...
            If IsNothing(vCcexCodi) = False Then
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE,ASNT_AUXILIAR_STRING,ASNT_LIN_VLIQ,ASNT_LIN_TIIMP,ASNT_CCEX_CODI,ASNT_AUXILIAR_STRING2,ASNT_TIPO_IMPUESTO) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vFactura & "','" & vSerie & "','" & vTipoFactura & "'," & vBase & "," & vTipoIgic & ",'" & vCcexCodi & "','" & vFaanCodi & "'," & vTipoIgic & ")"
            ...
            ElseIf IsNothing(vReseCodi) = False Then
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE,ASNT_AUXILIAR_STRING,ASNT_LIN_VLIQ,ASNT_LIN_TIIMP,ASNT_CCEX_CODI,ASNT_RESE_CODI,ASNT_RESE_ANCI,ASNT_ALOJ_CODI,ASNT_AUXILIAR_STRING2,ASNT_TIPO_IMPUESTO ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vFactura & "','" & vSerie & "','" & vTipoFactura & "'," & vBase & "," & vTipoIgic & ",'" & vCcexCodi & "'," & vReseCodi & "," & vReseAnci & ",'" & vAlojCodi & "','" & vFaanCodi & "'," & vTipoIgic & ")"
            ...
            Else
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE,ASNT_AUXILIAR_STRING,ASNT_LIN_VLIQ,ASNT_LIN_TIIMP,ASNT_AUXILIAR_STRING2,ASNT_TIPO_IMPUESTO) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vFactura & "','" & vSerie & "','" & vTipoFactura & "'," & vBase & "," & vTipoIgic & ",'" & vFaanCodi & "'," & vTipoIgic & ")"
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
                                     ...
                                     , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double,
                                       ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String,
                                       ByVal vImprimir As String, ByVal vAuxiliarString As String,
                                       ByVal vMultiDiario As Boolean, ByVal vDptoNh As String, ByVal vCcexCodi As String, ByVal vReseCodi As String, ByVal vReseAnci As String, ByVal vAlojCodi As String, vFactura As String, vSerie As String, vNada As String)
        ...
        Try
            ...
            If IsNothing(vCcexCodi) = False Then
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_AUXILIAR_STRING,ASNT_DPTO_CODI,ASNT_DPTO_DESC,ASNT_CCEX_CODI,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste
                SQL += "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vAuxiliarString & "','" & vDptoNh & "','" & Me.mAuxStr & "','" & vCcexCodi & "','" & vFactura & "','" & vSerie & "')"
            ...
            ElseIf IsNothing(vReseCodi) = False Then
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_AUXILIAR_STRING,ASNT_DPTO_CODI,ASNT_DPTO_DESC,ASNT_CCEX_CODI,ASNT_RESE_CODI,ASNT_RESE_ANCI,ASNT_ALOJ_CODI,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste
                SQL += "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vAuxiliarString & "','" & vDptoNh & "','" & Me.mAuxStr & "','" & vCcexCodi & "'," & vReseCodi & "," & vReseAnci & ",'" & vAlojCodi & "','" & vFactura & "','" & vSerie & "')"
            ...
            Else
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_AUXILIAR_STRING,ASNT_DPTO_CODI,ASNT_DPTO_DESC,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste
                SQL += "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vAuxiliarString & "','" & vDptoNh & "','" & Me.mAuxStr & "','" & vFactura & "','" & vSerie & "')"
    ...
    End Sub
    ''101
    Private Sub InsertaOracle101(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
                                    ByVal vCfatocab_Refer As Integer, ByVal vLinea As Integer _
                                    , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double,
                                      ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String, ByVal vImprimir As String,
                                      ByVal vAuxiliarString As String, ByVal vFactura As String, ByVal vSerie As String)
   ...
   ByVal vSerie As String, ByVal vNfactura As Integer, ByVal vImonep As Double, ByVal vSfactura As String, ByVal vCuenta As String, ByVal vCif As String)
    ...
    Private Sub CerrarFichero()
        Try
            Filegraba.Close()
            ' y lo borra 
            System.IO.File.Delete(Me.mParaFilePath & Me.mParaFileName)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
...
#Region "ASIENTO-1"
    ...
    End Sub
    Private Sub VentasDepartamentoVitalResto()
        ...
        SQL = "SELECT SERV_CAME ,SERV_COCE FROM TNHT_PAR1 "

        Me.DbLeeHotel.TraerLector(SQL)
        Me.DbLeeHotel.mDbLector.Read()

        If Me.DbLeeHotel.mDbLector.HasRows Then
            DepartamentosForFait += CStr(Me.DbLeeHotel.mDbLector.Item("SERV_CAME")) & "','" _
            & CStr(Me.DbLeeHotel.mDbLector.Item("SERV_COCE")) & "'"
        End If
        Me.DbLeeHotel.mDbLector.Close()



        ' SE añade servicio de suplemento desayuno
        If Me.mParaSecc_DepSuplementoDesayuno.Length > 0 Then
            DepartamentosForFait += ",'" & Me.mParaSecc_DepSuplementoDesayuno & "'"
        End If


        DepartamentosForFait = "(" & DepartamentosForFait & ")"
        ...
        SQL = "SELECT  "
        SQL += "DECODE(ENTI_FAMA,'1','AGENCIAS','2','PRIVADO','PRIVADO') AS ENTI_FAMA, "
        ...
        SQL += "        DECODE(ENTI_FAMA,'1','AGENCIAS','2','PRIVADO','PRIVADO')  "
        SQL += " ,TNHT_SERV.SERV_TICO "
        '  SQL += " ORDER BY TNHT_SERV.SERV_TICO "
        SQL += " ORDER BY TNHT_SERV.SERV_DESC"
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If CStr(Me.DbLeeHotel.mDbLector("ENTI_FAMA")) = "AGENCIAS" Then
    ...
    End Sub
    Private Sub VentasDepartamentoVitalAgenciasForfaitDetalle()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If Total <> 0 Then
                Me.mTipoAsiento = "HABER"
                Me.InsertaOracle("AC", 101, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, CType(Me.DbLeeHotel.mDbLector("DEPARTAMENTO"), String) & " [" & CType(Me.DbLeeHotel.mDbLector("ENTI_FAMA"), String) & "]", Total, "NO", "", vCentroCosto, "SI", CStr(Me.DbLeeHotel.mDbLector("SERVICIO")), CStr(Me.DbLeeHotel.mDbLector("DEPARTAMENTO")), TipoCuenta, "", CStr(Me.DbLeeHotel.mDbLector("SECCION")), vCentroCosto)
                Me.GeneraFileAC("AC", Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), Cuenta, Me.mIndicadorHaber, CType(Me.DbLeeHotel.mDbLector("DEPARTAMENTO"), String), Total)
                If vCentroCosto <> "0" Then
                    '           Me.GeneraFileAA("AA", 1, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), "0", vCentroCosto, Total)
                End If
    ...
    Private Sub VentasDepartamentoVitalPrivados()
        ...
        'Texto = "PENDIENTE DE FACTURAR"
        ' Texto = "PRODUCCIÓN DÍA (FORFAIT PRIV Y EXTRAS) " & Me.mFecha
        Texto = "PRODUCCIÓN  (PRIV Y EXTRAS)`" & Me.mFecha
        ...
        Me.DbLeeHotel.mDbLector.Close()
    End Sub
    Private Sub VentasDepartamentoVitalAgencias()
        ...
        'Texto = "PENDIENTE DE FACTURAR"
        Texto = "PRODUCCIÓN (Agencias) " & Me.mFecha
        ...
        If Total2 <> 0 Then
            ...
            Me.InsertaOracle("AC", 101, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Me.mCtaManoCorriente, Me.mIndicadorDebe, Texto, Total2, "SI", "", "", "SI")
            Me.GeneraFileAC("AC", Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), Me.mCtaManoCorriente, Me.mIndicadorDebe, Texto, Total2)
...
#Region "ASIENTO-2 PAGOS A CUENTA"
    Private Sub TotalPagosaCuentaVisas()
        Try
            ...
            SQL = SQL & "NVL(FNHT_MOVI_RECI(TNHT_MOVI.MOVI_CODI,TNHT_MOVI.MOVI_DARE,TNHT_MOVI.MOVI_TIMO),'?') RECI_COBR,NVL(MOVI_NUDO,' ') MOVI_NUDO,NVL(MOVI_DESC,' ') MOVI_DESC,NVL(SECC_REFE,'?') AS SECC_CODI"
            ...
            SQL = SQL & " FROM " & Me.mStrHayHistorico & " TNHT_MOVI,TNHT_CACR,TNHT_RESE,TNHT_CCEX ,TNHT_SECC "
            ...
            SQL = SQL & " AND TNHT_MOVI.SECC_CODI = TNHT_SECC.SECC_CODI(+)"
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("RESE_CODI")) = False Then
                    ReseCodi = CStr(Me.DbLeeHotel.mDbLector("RESE_CODI"))
                Else
                    ReseCodi = Nothing
                End If

                If IsDBNull(Me.DbLeeHotel.mDbLector("RESE_ANCI")) = False Then
                    ReseAnci = CStr(Me.DbLeeHotel.mDbLector("RESE_ANCI"))
                Else
                    ReseAnci = Nothing
                End If
    ...
    Private Sub TotalPagosaCuentaOtrasFormas()
        ...
        SQL = SQL & " ,TNHT_MOVI.CCEX_CODI AS CCEX_CODI,NVL(TNHT_CCEX.CCEX_TITU,' ') AS CCEX_TITU "
        SQL = SQL & ",TNHT_MOVI.RESE_CODI,TNHT_MOVI.RESE_ANCI,TNHT_MOVI.ALOJ_CODI "
        SQL = SQL & " FROM " & Me.mStrHayHistorico & " TNHT_MOVI,TNHT_FORE,TNHT_RESE,TNHT_CCEX,TNHT_SECC "
    ...
    Private Sub DetallePagosaCuentaVisas()
        ...
        SQL = SQL & " TNHT_CACR.CACR_DESC TARJETA,MOVI_DAVA,NVL(SECC_REFE,'?') AS SECC_CODI "
        SQL = SQL & " ,TNHT_MOVI.CCEX_CODI AS CCEX_CODI,NVL(TNHT_CCEX.CCEX_TITU,' ') AS CCEX_TITU "
        SQL = SQL & ",TNHT_MOVI.RESE_CODI,TNHT_MOVI.RESE_ANCI,TNHT_MOVI.ALOJ_CODI "
        SQL = SQL & " FROM " & Me.mStrHayHistorico & " TNHT_MOVI,"
        SQL = SQL & " TNHT_CACR,TNHT_RESE,TNHT_CCEX,TNHT_SECC  WHERE TNHT_MOVI.CACR_CODI = TNHT_CACR.CACR_CODI"
        SQL = SQL & " AND TNHT_MOVI.RESE_CODI = TNHT_RESE.RESE_CODI(+) "
        SQL = SQL & " AND TNHT_MOVI.RESE_ANCI = TNHT_RESE.RESE_ANCI(+)"
    ...
    Private Sub DetallePagosaCuentaOtrasFormas()
        ...
        SQL = "SELECT TNHT_MOVI.RESE_CODI || '/' || TNHT_MOVI.RESE_ANCI RESERVA,NVL(RESE_ANPH,'?') CLIENTE,TNHT_MOVI.MOVI_VDEB TOTAL,TNHT_FORE.FORE_DESC TIPO,NVL(TNHT_FORE.FORE_CTB1,'0') CUENTA,MOVI_DAVA,NVL(MOVI_DESC,' ') MOVI_DESC,NVL(SECC_REFE,'?') AS SECC_CODI "

        SQL = SQL & " ,TNHT_MOVI.CCEX_CODI AS CCEX_CODI ,NVL(TNHT_CCEX.CCEX_TITU,' ') AS CCEX_TITU "

        SQL = SQL & ",TNHT_MOVI.RESE_CODI,TNHT_MOVI.RESE_ANCI,TNHT_MOVI.ALOJ_CODI "
        SQL = SQL & " FROM " & Me.mStrHayHistorico & " TNHT_MOVI,TNHT_FORE,TNHT_RESE,TNHT_CCEX,TNHT_SECC WHERE "
...
#Region "ASIENTO-3"
    ...
    Private Sub NFacturasSalidaTotalFActuraNuevo()
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If CStr(Me.DbLeeHotel.mDbLector("ESTADO")) <> "2" Then
    ...
    Private Sub NFacturasSalidaDetalleIgic()
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                Else
                    'FACTURAS DE CREDITO
                    Me.InsertaOracleGustavo("AC", 101, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), Me.mIndicadorHaber, CType(Me.DbLeeHotel.mDbLector("DESCRIPCION"), String), TotalIva, "NO", Me.mClientesContadoCif, "", "SI", CStr(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")), TipoFactura, TotalBase, CType(Me.DbLeeHotel.mDbLector("TIPO"), Double), CcExCodi, ReseCodi, ReseAnci, AlojCodi, FacturaAnulada)
                End If
    ...
    Private Sub NFacturasSalidaBaseImponibleAgrupado()
        ...
        Try
            ...
            SQL = "SELECT  DECODE(FACT_STAT,2,'CREDITO','RESTO') AS TIPO,"
            ...
            SQL += "AND TNHT_FAIV.TIVA_CODI = TNHT_TIVA.TIVA_CODI "
            SQL += "AND (TNHT_FACT.FACT_DAEM = " & "'" & Me.mFecha & "') "
            SQL += "GROUP BY TNHT_FACT.SEFA_CODI,FACT_STAT"
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If CStr(Me.DbLeeHotel.mDbLector("TIPO")) = "CREDITO" Then
                    Me.InsertaOracle("AC", 101, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, DescripcionAsiento, TotalBase, "NO", Me.mClientesContadoCif, "", "SI", CStr(Me.DbLeeHotel.mDbLector("SERIE")))
                Else
...
#Region "ASIENTO-51"
    ...
    Private Sub NotasDeCreditoEntidadCreditoBaseImponible2()
        ...
        SQL = "SELECT TNHT_NCRE.NCRE_NECO,"
        ...
        SQL += " AND TNHT_NCRE.NCRE_DAEM = " & "'" & Me.mFecha & "' "
        SQL += " GROUP BY TNHT_NCRE.SEDO_CODI,TNHT_NCRE.NCRE_NECO"
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.mTipoAsiento = "HABER"
            If IsDBNull(DbLeeHotel.mDbLector("NCRE_NECO")) Then
            ...
            Else
                Me.InsertaOracle("AC", 101, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, Descripcion, TotalBase, "NO", "", "", "SI")
            End If
...
#Region "ASIENTO-35"
    Private Sub FacturasContadoTotal()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If Total <> 0 Then
                Linea = Linea + 1
                Me.mTipoAsiento = "HABER"
                Me.InsertaOracle("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, CType(Me.DbLeeHotel.mDbLector("NUMERO"), String) & "/" & CType(Me.DbLeeHotel.mDbLector("SERIE"), String), Total, "SI", "", "", "SI", "", Me.Multidiario, "", CcExCodi, ReseCodi, ReseAnci, AlojCodi, CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String), "")
    ...
    Private Sub FacturasContadoTotalVisas()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.mTipoAsiento = "DEBE"
            Me.InsertaOracle101("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), Me.mIndicadorDebe, Descripcion, Total, "NO", "", "", "SI", "COBRO", CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String), CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String))
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Descripcion = CType(Me.DbLeeHotel.mDbLector("TARJETA"), String) & " " & CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String) & "/" & CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String) & " " & CType(Me.DbLeeHotel.mDbLector("TITULAR"), String)
            Me.mTipoAsiento = "DEBE"
            Me.InsertaOracle101("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), Me.mIndicadorDebe, Descripcion & " Deducido", Total, "NO", "", "", "SI", "COBRO", CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String), CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String))
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If Saldo <> 0 Then
                    ...
                    Me.mTipoAsiento = "DEBE"
                    Me.InsertaOracle("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Me.mCtaPagosACuenta, Me.mIndicadorDebe, "Saldo de Anticipos al Facturar " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), Saldo, "NO", "", "Recibido " & "" & " Fac: " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), "SI", "SALDO ANTICIPO FACTURADO", CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String), CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String), "")
                    ...
                    Me.mTipoAsiento = "HABER"
                    Me.InsertaOracle("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, "Saldo de Anticipos al Facturar " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), Saldo, "NO", "", "Recibido " & "" & " Fac: " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), "SI", "SALDO ANTICIPO FACTURADO", CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String), CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String), "")
...
#Region "ASIENTO-22 DEVOLUCIONES EN FACTURA "
    Private Sub TotalDevolucionesVisasFacturado()
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                Me.InsertaOracle101("AC", 22, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, CType(Me.DbLeeHotel.mDbLector("TARJETA"), String) & " " & Factura, Total, "NO", "", "", "SI", "COBRO", CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String), CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String))
    ...
    Private Sub TotalDevolucionesOtrasFormasFacturado()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.InsertaOracle101("AC", 22, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, CType(Me.DbLeeHotel.mDbLector("TIPO"), String) & " " & Factura, Total, "NO", "", "", "SI", "COBRO", CType(Me.DbLeeHotel.mDbLector("FACT_CODI"), String), CType(Me.DbLeeHotel.mDbLector("SEFA_CODI"), String))
    ...
    Private Sub DetalleDevolucionesVisasFacturado()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.InsertaOracle101("AC", 22, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, "Devol. Pag A Cuenta RVA= " & CType(Me.DbLeeHotel.mDbLector("RESERVA"), String) & " " & CType(Me.DbLeeHotel.mDbLector("CLIENTE"), String).Replace("'", "''"), Total, "NO", "", "", "SI", "COBRO", CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String))
...
#Region "ASIENTO-60 OPERECIONES DE CAJA"
    Private Sub OperacionesDeCaja()
        Try
            ...
            SQL += " AND UPPER(MOCA_OBSE) NOT LIKE   '%SALIDA%'"
            SQL += " AND UPPER(MOCA_OBSE) NOT LIKE   '%TARJETA%'"
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                Cuenta = Me.mCtaDebeCaja
                Total = CType(Me.DbLeeHotel.mDbLector("TOTAL"), Double)

                Me.mTipoAsiento = "DEBE"
                Me.InsertaOracle("AC", 60, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, "Entradas de Caja " & CType(Me.DbLeeHotel.mDbLector("MOCA_OBSE"), String), Total, "NO", "", "", "SI", "", "", "")
                ...
                Linea = Linea + 1
                Cuenta = Me.mCtaHaberCaja

                Me.mTipoAsiento = "HABER"
                Me.InsertaOracle("AC", 60, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, "Entradas de Caja " & CType(Me.DbLeeHotel.mDbLector("MOCA_OBSE"), String), Total, "NO", "", "", "SI", "", "", "")
                Me.GeneraFileACMultiDiario("AC", Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), Cuenta, Me.mIndicadorHaber, "Entradas de Caja " & CType(Me.DbLeeHotel.mDbLector("MOCA_OBSE"), String), Total, Me.Multidiario)
            ...
            ' TRATA DE EVITAR LAS SALIDAS DE CAJA DE LAS FORMAS DE COBRO QUE NO SON DE EFECTIVO
            SQL += "   AND MOCA_VDEB NOT IN"
            SQL += "     (SELECT  SUM(MOVI_VDEB)  FROM TNHT_MOVI,TNHT_FORE "
            SQL += "        "
            SQL += "       WHERE TNHT_MOVI.FORE_CODI = TNHT_FORE.FORE_CODI "
            SQL += "       AND  TNHT_MOVI.MOVI_DATR = " & "'" & Me.mFecha & "'"
            SQL += "       AND TNHT_MOVI.FORE_CODI <> '" & Me.mForeCodiEfectivo & "'"
            SQL += "        "
            SQL += "       GROUP BY MOVI_DATR , FORE_DESC) "
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                Me.mTipoAsiento = "HABER"
                Me.InsertaOracle("AC", 61, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, "Salidas de Caja " & CType(Me.DbLeeHotel.mDbLector("MOCA_OBSE"), String), Total, "NO", "", "", "SI", "", "", "")
                ...
                Me.mTipoAsiento = "DEBE"
                Me.InsertaOracle("AC", 61, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, "Salidas de Caja " & CType(Me.DbLeeHotel.mDbLector("MOCA_OBSE"), String), Total, "NO", "", "", "SI", "", "", "")
                Me.GeneraFileACMultiDiario("AC", Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), Cuenta, Me.mIndicadorDebe, "Salidas de Caja " & CType(Me.DbLeeHotel.mDbLector("MOCA_OBSE"), String), Total, Me.Multidiario)
    ...
    Public Sub Procesar()
        Try
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Verificando Histórico " & Me.mFecha
                Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                Me.VentasDepartamentoVitalPrivados()

                Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Pdte. Facturar"
                Me.mTextDebug.Update()
                Me.VentasDepartamentoVitalResto()


                Me.VentasDepartamentoVitalAgencias()
                Me.VentasDepartamentoVitalAgenciasForfaitDetalle()


                Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Ventas por Departamento"
                Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                If Me.mTrataCaja Then
                    If Me.mPerfilCobtable = "CAJA" Or Me.mPerfilCobtable = "AMBOS" Then
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Pagos a Cuenta Visas"
                        Me.mTextDebug.Update() '
                        Me.TotalPagosaCuentaOtrasFormas()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Pagos a Cuenta Otras Formas de Pago"
                        Me.mTextDebug.Update() '

                        Me.DetallePagosaCuentaVisas()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Pagos a Cuenta Visas"
                        Me.mTextDebug.Update()

                        Me.DetallePagosaCuentaOtrasFormas()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Pagos a Cuenta Otras Formas"
                        Me.mTextDebug.Update()

                        '   Me.TotalPagosaCuentaVisasComision()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "COMISION Visas  de Pagos a Cuenta "
                        Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                If Me.mPerfilCobtable = "CAJA" Or Me.mPerfilCobtable = "AMBOS" Then
                    If Me.mTrataCaja Then
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Devoluciones Visas"
                        Me.mTextDebug.Update()

                        'Me.TotalDevolucionesOtrasFormas()
                        Me.TotalDevolucionesOtrasFormasDetalle()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Devoluciones Otras Formas de Pago"
                        Me.mTextDebug.Update()

                        Me.DetalleDevolucionesVisas()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Devoluciones Visas"
                        Me.mTextDebug.Update()

                        Me.DetalleDevolucionesOtrasFormas()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Devoluciones Otras Formas"
                        Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                If Me.mTrataCaja Then
                    If Me.mPerfilCobtable = "CAJA" Or Me.mPerfilCobtable = "AMBOS" Then
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Devoluciones Visas en Factura"
                        Me.mTextDebug.Update()

                        Me.TotalDevolucionesOtrasFormasFacturado()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Devoluciones Otras Formas de Pago en Factura"
                        Me.mTextDebug.Update()

                        Me.DetalleDevolucionesVisasFacturado()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Devoluciones Visas en Factura"
                        Me.mTextDebug.Update()

                        Me.DetalleDevolucionesOtrasFormasFacturado()
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Devoluciones Otras Formas en Factura"
                        Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                If Me.mPerfilCobtable = "FACTURAS" Or Me.mPerfilCobtable = "AMBOS" Then
                    ...
                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Total Pendiente de Facturar"
                    Me.mTextDebug.Update()
                    ...
                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Descuentos Financieros y Comisiones Facturas"
                    Me.mTextDebug.Update()
                    '2A
                    ...
                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Impuesto Facturas "
                    Me.mTextDebug.Update()
                    '3
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                If Me.mPerfilCobtable = "CAJA" Or Me.mPerfilCobtable = "AMBOS" Then
                    ...
                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Total Líquido Facturas de Salida (contado)"
                    Me.mTextDebug.Update()
                    Me.FacturasContadoTotal()


                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Total Visas Facturas de Salida (contado)"
                    Me.mTextDebug.Update()
                    Me.FacturasContadoTotalVisas()

                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Total Otras Formas Facturas de Salida (contado)"
                    Me.mTextDebug.Update()
                    ...
                    Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Calculando Saldo de Anticipos Facturas de Salida (contado)"
                    Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                If Me.mPerfilCobtable = "FACTURAS" Or Me.mPerfilCobtable = "AMBOS" Then
                    ...
                    If Me.TotalRegistros > 0 Then
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Notas de Crédito"
                        Me.mTextDebug.Update()
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Detalle de Impuesto Notas de Crédito"
                        Me.mTextDebug.Update()
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Acumulado Base Imponible Notas de Crédito de la Serie de Documento"
                        Me.mTextDebug.Update()
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Líquido Notas de Crédito"
                        Me.mTextDebug.Update()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                If Me.mPerfilCobtable = "CAJA" Or Me.mPerfilCobtable = "AMBOS" Then
                    If Me.mTrataCaja Then
                        ...
                        Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "OPERACIONES DE CAJA "
                        Me.mTextDebug.Update()
            ...
            Me.CerrarFichero()
            '  Me.CierraConexiones()
            Me.mTextDebug.Text = Format(Me.mFecha, "dd/MM/yyyy") & " " & "Fin de Integración"
            Me.mTextDebug.Update()
