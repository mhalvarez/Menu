...
#Region "RUTINAS VARIAS"
    Private Sub CrearFichero(ByVal vFile As String)
        ...
        End Try
    End Sub
    Private Sub BorrarFichero(ByVal vFile As String)
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
        ...
        End Try
    End Sub
    ' aqui nuevo para igic 
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
                                     ByVal vCfatocab_Refer As Integer, ByVal vLinea As Integer _
                                     , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double, _
                                       ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String, ByVal vImprimir As String, _
                                       ByVal vAuxiliar As String, ByVal vBase As Double, ByVal vTipoIgic As Double, ByVal vDocumento As String, ByVal vIdentificador As String, ByVal vCuentaCliente As String)
        ...
        Try
            ...
            SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
            SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
            SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_AUXILIAR_STRING,ASNT_LIN_VLIQ,ASNT_LIN_TIIMP,ASNT_LIN_DOCU,ASNT_AUXILIAR_STRING2,ASNT_AUXILIAR_STRING3) values ('"
            SQL += vTipo & "','"
            SQL += vEmpGrupoCod & "','"
            SQL += vEmpCod & "','"
            SQL += vCefejerc_Cod & "','"
            ...
            SQL += Format(Now, "dd/MM/yyyy") & "','"
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & _
            ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "','" & vAuxiliar & "'," & vBase & "," & vTipoIgic & ",'" & vDocumento & "','" & vIdentificador & "','" & vCuentaCliente & "')"
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
        ...
        Try
            ...
            SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
            SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
            SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_AUXILIAR_STRING,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE) values ('"
            SQL += vTipo & "','"
            SQL += vEmpGrupoCod & "','"
            SQL += vEmpCod & "','"
            SQL += vCefejerc_Cod & "','"
            ...
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "','" & vAuxiliarString & "','" & vFactura & "','" & vSerie & "')"
        ...
        End Try
    End Sub
    Private Sub InsertaOracleNotaCre(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
                                    ByVal vCfatocab_Refer As Integer, ByVal vLinea As Integer _
                                    , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double, _
                                      ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String, ByVal vImprimir As String, ByVal vAuxiliarString As String, ByVal vFactura As String, ByVal vSerie As String)
        ...
        End Try
    End Sub
    Private Sub InsertaOracleNotaCre2(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
                                     ByVal vCfatocab_Refer As Integer, ByVal vLinea As Integer _
                                     , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double, _
                                       ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String, ByVal vImprimir As String, ByVal vAux As String)
        ...
        Try
            ...
            SQL += Format(Now, "dd/MM/yyyy") & "','"
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "','" & vAux & "')"
        ...
        End Try
    End Sub
    Private Sub InsertaOracleNotaCre3(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
                                     ByVal vCfatocab_Refer As Integer, ByVal vLinea As Integer _
                                     , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double, _
                                       ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String, ByVal vImprimir As String, ByVal vAux As String, ByVal vIdentificador As String, ByVal vBase As Double, ByVal vTipoI As String, ByVal vSerie As String, ByVal vNumero As Integer, ByVal vCuentaCliente As String)
        ...
        Try
            ...
            SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
            SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
            SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_AUXILIAR_STRING,ASNT_AUXILIAR_STRING2,ASNT_LIN_VLIQ,ASNT_LIN_TIIMP,ASNT_FACTURA_SERIE,ASNT_FACTURA_NUMERO,ASNT_AUXILIAR_STRING3) values ('"
            SQL += vTipo & "','"
            SQL += vEmpGrupoCod & "','"
            SQL += vEmpCod & "','"
            SQL += vCefejerc_Cod & "','"
            ...
            SQL += Format(Now, "dd/MM/yyyy") & "','"
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "','" & vAux & "','" & vIdentificador & "'," & vBase & "," & vTipoI & ",'" & vSerie & "'," & vNumero & ",'" & vCuentaCliente & "')"
...
#Region "ASIENTO-1"
    ...
    Private Sub VentasDepartamento()
        ...
        SQL = "SELECT TNHT_MOVI.SERV_CODI SERVICIO,TNHT_SERV.SERV_DESC DEPARTAMENTO,NVL(TNHT_SERV.SERV_CTB1,'0') CUENTA ,"
        ...
        SQL += " GROUP BY TNHT_MOVI.SERV_CODI,TNHT_SERV.SERV_DESC,TNHT_SERV.SERV_CTB1,TNHT_SERV.SERV_COMS"



        'SQL += " ORDER BY TNHT_MOVI.SECC_CODI,TNHT_MOVI.SERV_CODI,TNHT_SERV.SERV_DESC,TNHT_SERV.SERV_CTB1"
        SQL += " ORDER BY TNHT_MOVI.SERV_CODI,TNHT_SERV.SERV_DESC,TNHT_SERV.SERV_CTB1"
...
#Region "ASIENTO-2 PAGOS A CUENTA"
    ...
    Private Sub TotalPagosaCuentaVisasComision()
        Try
            ...
            SQL = "SELECT SUM(TNHT_MOVI.MOVI_VDEB)TOTAL,TNHT_CACR.CACR_DESC TARJETA,NVL(TNHT_CACR.CACR_CTBA,'0') CUENTA,NVL(TNHT_CACR.CACR_CTBA,'0') CUENTAGASTO,TNHT_CACR.CACR_COMI"
            SQL = SQL & " FROM TNHT_MOVI,TNHT_CACR,TNHT_RESE WHERE TNHT_MOVI.CACR_CODI = TNHT_CACR.CACR_CODI"
            SQL = SQL & " AND TNHT_MOVI.RESE_CODI = TNHT_RESE.RESE_CODI(+) "
            SQL = SQL & " AND TNHT_MOVI.RESE_ANCI = TNHT_RESE.RESE_ANCI(+)"
            SQL = SQL & " AND TNHT_MOVI.TIRE_CODI = 1"
            ...
            End If
            '
            SQL = SQL & " GROUP BY TNHT_MOVI.CACR_CODI,TNHT_CACR.CACR_DESC,TNHT_CACR.CACR_CTBA,TNHT_CACR.CACR_CTBA,TNHT_CACR.CACR_COMI"
...
#Region "ASIENTO-2 PAGOS A CUENTA NEWGOLF"
    ...
    Private Sub TotalPagosaCuentaVisasComisionGolf()
        Try
            ...
            SQL = "SELECT SUM(MOVI_IMPT) TOTAL,CACR_DESC TARJETA,nvl(CACR_CTBA,'0') CUENTA,NVL(TNHT_CACR.CACR_CTBA,'0') CUENTAGASTO,TNHT_CACR.CACR_COMI "
            SQL += " FROM " & Me.mParaUsuarioNewGolf & ".TNPL_MOVI," & Me.mParaUsuarioNewGolf & ".TNPL_CACO,TNHT_CACR "
            SQL += " WHERE "
            ...
            SQL = SQL & " AND TNPL_MOVI.MOVI_FECH = " & "'" & Me.mFecha & "'"
            SQL = SQL & " GROUP BY CACR_DESC,CACR_CTBA,CACR_CTBA,CACR_COMI"
...
20080721:
    ...
    Private Sub FacturasSalidaTotalFActuraNuevo()
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                Me.mTipoAsiento = "DEBE"
                '  Me.InsertaOracle("FV", 3, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, "Factura : " & CType(Me.DbLeeHotel.mDbLector("DESCRIPCION"), String), TotalFactura, "NO", Dni, Titular, "SI", "COBRO")
                ...
                ' genera registros de igic de la factura
                Me.FacturasSalidaIgic(CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String), Cuenta)
    ...
    Private Sub FacturasSalidaIgic(ByVal vFactura As String, ByVal vSerie As String, ByVal vCuentaCliente As String)

        Try

            Dim Lineasigic As Integer
            Dim Registrosledos As Integer
            Dim Identificador As String

            ' Contar Lineas de igic de la Factura 
            ...
            Lineasigic = Me.DbLeeHotelAux.EjecutaSqlScalar(SQL)
            ...
            While Me.DbLeeHotelAux.mDbLector.Read
                Linea = Linea + 1
                Registrosledos = Registrosledos + 1

                DescripcionAsiento = CType(Me.DbLeeHotelAux.mDbLector("FAIV_TAXA"), String) & " Factura " & CType(Me.DbLeeHotelAux.mDbLector("DOCUMENTO"), String)
                ...
                TotalIva = CType(Me.DbLeeHotelAux.mDbLector("IGIC"), Decimal)
                TotalIva = Decimal.Round(CType(TotalIva, Decimal), 2)


                TotalBase = CType(Me.DbLeeHotelAux.mDbLector("BASE"), Decimal)
                TotalBase = Decimal.Round(CType(TotalBase, Decimal), 2)
                ...
                If Registrosledos < Lineasigic Then
                    Identificador = "M"
                Else
                    Identificador = "U"
                ...
                Me.InsertaOracle("AC", 3, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotelAux.mDbLector("CUENTA"), String), Me.mIndicadorHaber, DescripcionAsiento, TotalIva, "NO", Me.mClientesContadoCif, "", "SI", "IGIC", TotalBase, CType(Me.DbLeeHotelAux.mDbLector("TIPO"), Double), CType(Me.DbLeeHotelAux.mDbLector("DOCUMENTO"), String), Identificador, vCuentaCliente)
                Me.GeneraFileAC("AC", Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), CType(Me.DbLeeHotelAux.mDbLector("CUENTA"), String), Me.mIndicadorHaber, DescripcionAsiento, TotalIva)
                Me.GeneraFileIV("IV", 3, Me.mEmpGrupoCod, Me.mEmpCod, "SERIE", 0, TotalBase, CType(Me.DbLeeHotelAux.mDbLector("TIPO"), Double), TotalIva, "X")
...
#Region "ASIENTO-34 FACTURACION NEWGOLF"
    Private Sub FacturasTotalLiquidoGolf()
        ...
        ' BLOQUEAR ABAJO SI NO SE QUIRE DTECTAR FACTURAS CON IGIC MAL CALCULADO = 04/03/2014   , 08/03/2014
...
#Region "ASIENTO-35 FACTURACION DE CONTADO"
    Private Sub FacturasContadoTotal()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If Total <> 0 Then
                Linea = Linea + 1
                Me.mTipoAsiento = "HABER"
                Me.InsertaOracle("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, "COBRO FRA. " & CType(Me.DbLeeHotel.mDbLector("NUMERO"), String) & "/" & CType(Me.DbLeeHotel.mDbLector("SERIE"), String), Total, "SI", "", CType(Me.DbLeeHotel.mDbLector("FACT_TITU"), String), "SI")
    ...
    Private Sub FacturasContadoTotaLOtrasFormas()
        ...
        SQL = ""
        SQL = "SELECT SUM(TNHT_MOVI.MOVI_VDEB)TOTAL,TNHT_FORE.FORE_DESC TIPO,NVL(TNHT_FORE.FORE_CTB1,'0') CUENTA,"
        SQL += "NVL(FAAN_CODI,'0') AS FAAN_CODI"
        SQL += " ,TNHT_FACT.FACT_CODI || '/' || TNHT_FACT.SEFA_CODI AS DOCUMENTO "
        SQL += "  FROM TNHT_MOVI,TNHT_FORE,TNHT_FACT,TNHT_FAMO WHERE"
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Descripcion = CType(Me.DbLeeHotel.mDbLector("TIPO"), String) & " " & CType(Me.DbLeeHotel.mDbLector("DOCUMENTO"), String)
    ...
    End Sub
    Private Sub FacturasContadoTotaLOtrasFormasAgrupado()
        Dim Total As Double
        Dim SQL As String
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Descripcion = "COBRO " & CType(Me.DbLeeHotel.mDbLector("TIPO"), String)
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Descripcion = "COBRO ANULADO " & CType(Me.DbLeeHotel.mDbLector("TIPO"), String)
    ...
    Private Sub FacturasContadoTotalVisasComision()
        ...
        SQL = "SELECT SUM(MOVI_VDEB) TOTAL,CACR_DESC TARJETA,nvl(CACR_CTBA,'0') CUENTA,NVL(TNHT_CACR.CACR_CTBA,'0') CUENTAGASTO,TNHT_CACR.CACR_COMI,"
        ...
        'SQL = SQL & " AND TNHT_MOVI.MOVI_CORR = '0' "
        SQL = SQL & " AND TNHT_FACT.FACT_DAEM = " & "'" & Me.mFecha & "'"
        SQL = SQL & " GROUP BY TNHT_CACR.CACR_DESC,TNHT_CACR.CACR_CTBA,TNHT_CACR.CACR_CTBA,TNHT_CACR.CACR_COMI,TNHT_FACT.FAAN_CODI"
...
#Region "ASIENTO-37 FACTURACION DE CONTADO  NEWGOLF"
    ...
    Private Sub FacturasContadoTotalVisasComisionGolf()
        ...
        SQL = "SELECT MOVI_IMPT TOTAL,CACR_DESC TARJETA,nvl(CACR_CTBA,'0') CUENTA,NVL(TNHT_CACR.CACR_CTBA,'0') CUENTAGASTO,TNHT_CACR.CACR_COMI,"
        SQL += " TNPL_FACT.SEFA_CODI,TNPL_FACT.FACT_CODI,NVL(TNPL_FACT.FACT_TITU,' ') AS TITULAR "
        SQL += " FROM " & Me.mParaUsuarioNewGolf & ".TNPL_MOVI," & Me.mParaUsuarioNewGolf & ".TNPL_CACO," & Me.mParaUsuarioNewGolf & ".TNPL_FACT," & Me.mParaUsuarioNewGolf & ".TNPL_FAMO,TNHT_CACR "
        SQL += " WHERE "
...
#Region "ASIENTO-51"
    ...
    Private Sub NotasDeCreditoEntidadCredito()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.NotasDeCreditoEntidadCreditoDetalleIgic2(CType(Me.DbLeeHotel.mDbLector("SERIE"), String), CType(Me.DbLeeHotel.mDbLector("NUMERO"), Integer), Cuenta)
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.mTipoAsiento = "HABER"
            ' Me.InsertaOracleNotaCre("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaberFac, CType(Me.DbLeeHotel.mDbLector("FACTURA"), String) & " Anulada ", Total, "NO", CType(Me.DbLeeHotel.mDbLector("CIF"), String), CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "SI", "NOTA DE CREDITO ANULADA", False, "")
            Me.InsertaOracleNotaCre("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaberFac, CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), Total, "NO", CType(Me.DbLeeHotel.mDbLector("CIF"), String), CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "SI", "NOTA DE CREDITO ANULADA", CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String))
            ...
            Me.NotasDeCreditoEntidadCreditoDetalleIgic2Anulado(CType(Me.DbLeeHotel.mDbLector("SERIE"), String), CType(Me.DbLeeHotel.mDbLector("NUMERO"), Integer), Cuenta)
        End While
        Me.DbLeeHotel.mDbLector.Close()
    End Sub
    Private Sub NotasDeCreditoEntidadCreditoDetalleIgic2(ByVal vSerie As String, ByVal vNumero As Integer, ByVal vCuentaCliente As String)
        Dim TotalIva As Double
        Dim TotalBase As Double
        Dim Totalfactura As Double
        ...
        SQL += " AND TNHT_NCRE.NCRE_CODI = " & vNumero
        SQL += " AND TNHT_NCRE.SEDO_CODI = '" & vSerie & "'"
        ...
        While Me.DbLeeHotelAux.mDbLector.Read
            ...
            Me.InsertaOracleNotaCre3("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotelAux.mDbLector("CUENTA"), String), Me.mIndicadorHaber, CType(Me.DbLeeHotelAux.mDbLector("DESCRIPCION"), String), TotalIva, "NO", "", "", "SI", "IGIC", Identificador, TotalBase, CStr(Me.DbLeeHotelAux.mDbLector("TIPO")), CStr(Me.DbLeeHotelAux.mDbLector("SERIE")), CInt(Me.DbLeeHotelAux.mDbLector("NUMERO")), vCuentaCliente)
    ...
    End Sub
    Private Sub NotasDeCreditoEntidadCreditoDetalleIgic2Anulado(ByVal vSerie As String, ByVal vNumero As Integer, ByVal vCuentaCliente As String)
        Dim TotalIva As Double
        Dim TotalBase As Double
        Dim Totalfactura As Double
        ...
        While Me.DbLeeHotelAux.mDbLector.Read
            ...
            If TotalIva <> 0 Then
                ...
                Me.InsertaOracleNotaCre3("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotelAux.mDbLector("CUENTA"), String), Me.mIndicadorDebe, CType(Me.DbLeeHotelAux.mDbLector("DESCRIPCION"), String) & " Anulada ", TotalIva, "NO", "", "", "SI", "IGIC", Identificador, TotalBase, CStr(Me.DbLeeHotelAux.mDbLector("TIPO")), CStr(Me.DbLeeHotelAux.mDbLector("SERIE")), CInt(Me.DbLeeHotelAux.mDbLector("NUMERO")), vCuentaCliente)
                ...
                Me.GeneraFileIV("IV", 51, Me.mEmpGrupoCod, Me.mEmpCod, Me.mParaSerieAnulacion & CType(Me.DbLeeHotelAux.mDbLector("SERIE"), String), CType(Me.DbLeeHotelAux.mDbLector("NUMERO"), Integer), TotalBase * -1, CType(Me.DbLeeHotelAux.mDbLector("TIPO"), Double), TotalIva * -1, CType(Me.DbLeeHotelAux.mDbLector("X"), String))
            End If
    ...
    Private Sub NotasDeCreditoEntidadCreditoBaseImponible2()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Descripcion = "Notas de Abono " & Me.mFecha
            ...
            Me.mTipoAsiento = "HABER"
            Me.InsertaOracleNotaCre2("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, Descripcion, TotalBase * -1, "NO", "", "", "SI", "RESUMEN")
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Totalfactura = Decimal.Round(CType(Me.DbLeeHotel.mDbLector("TOTAL"), Decimal), 2)
            Descripcion = "Notas de Abono Anuladas " & Me.mFecha
            ...
            Me.mTipoAsiento = "DEBE"
            Me.InsertaOracleNotaCre2("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Descripcion, TotalBase, "NO", "", "", "SI", "RESUMEN")
    ...
    Public Sub Procesar()
        Try
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                Me.FacturasContadoTotaLOtrasFormasAgrupado()
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                If Me.TotalRegistros > 0 Then
                    ...
                    '2014 03 13  activar dos lineas de abajo patra procesar notas de credito en parque tropical 
            ...
            Me.BorrarFichero(Me.mParaFilePath & Me.mFileName)
        Catch EX As Exception
            MsgBox(EX.Message)
        End Try
