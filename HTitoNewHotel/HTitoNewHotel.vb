...
Public Class HTitoNewHotel
    ...
    Private DbGrabaCentral2 As C_DATOS.C_DatosOledb
...
#Region "CONSTRUCTOR"
    ...
    ByVal vUsaTnhtMoviAuto As Boolean, ByVal vEmpNum As Integer, ByVal vForm As System.Windows.Forms.Form, ByVal vMuestraIncidencias As Boolean, ByVal vPerfilContable As String, ByVal vTrataCaja As Boolean)
        ...
        Texto += " Ojo la Referencia del proyecto menu hacia la dll htitonewhotel esta apuntando a la dll de la carpeta debug "
        Texto += vbCrLf
        Texto += "al terminar de depurar VOLVER A APUNTARLA a la carpeta BIN !!!! "
...
#Region "METODOS Privados"
    ...
    Private Sub AbreConexiones()
        Try
            ...
            Me.DbGrabaCentral2 = New C_DATOS.C_DatosOledb(Me.mStrConexionCentral)
            Me.DbGrabaCentral2.AbrirConexion()
            Me.DbGrabaCentral2.EjecutaSqlCommit("ALTER SESSION SET NLS_DATE_FORMAT='DD/MM/YYYY'")
    ...
    Private Sub InsertaOracleMorasol(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
                                     ...
                                     vMoraReserva As String, vMoraLiquidar As String, vAuxiliar1Morasol As String, vAuxiliar2Morasol As String, vTipoDoc As String, vWebServiceName As String,
                                     vIvaNegocio As String, vIvaProducto As String, vGrupoNegocio As String, vGrupoProducto As String, vCodProcedencia As String)
        ...
        Try
            ...
            SQL += vCfcta_Cod & "','"
            SQL += vCfcptos_Cod & "','"
            SQL += Mid(Me.mMovimientoNegativo & vAmpcpto, 1, 150).Replace("'", ",") & "',"
            SQL += vImonep & ","
            SQL += "'N','"
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
            SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste & "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vFactura & "','" & vSerie & "','"
            SQL += vMoraNDoc & "','" & vMoraTipoMov & "','" & vMoraDimenNaturaleza & "','" & vMoraDimenDpto & "','" & vMoraDimenAcceso & "','" & vMoraReserva & "','" & vMoraLiquidar & "','" & vAuxiliar1Morasol & "','" & vTipoDoc & "','" & vWebServiceName & "','" & vIvaNegocio & "','" & vIvaProducto & "','" & vGrupoNegocio & "','" & vGrupoProducto & "','" & vCodProcedencia & "')"
   ...
   ByVal vSerie As String, ByVal vNfactura As Integer, ByVal vImonep As Double, ByVal vSfactura As String, ByVal vCuenta As String, ByVal vCif As String)
    ...
    Public Sub CierraConexiones()
        Try
            ...
            Me.DbGrabaCentral2.CerrarConexion()
...
#Region "ASIENTO-2 PAGOS A CUENTA"
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If Me.mParaDistingeAnticiposDeDepositos = True And CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String) = Me.mParaSecc_DepNh Then
                    ...
                    TipoDoc = ""
                    Texto = "(Depósito) " & Me.DbLeeHotel.mDbLector("MOVI_DESC")
                Else
                    Cuenta = CType(Me.DbLeeHotel.mDbLector("CUENTA"), String)
                    '   TipoDoc = Me.mParaMoraTDocAnticipo
                    TipoDoc = ""
                    Texto = "(Anticipo) " & Me.DbLeeHotel.mDbLector("MOVI_DESC")
                End If
                ...
                If Total <> 0 Then
                    ...
                    If IsDBNull(Me.DbLeeHotel.mDbLector("RECI_COBR")) Then
                        ' esta anulado
                        Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Me.mVisaCfbcotmov, "", Me.mVisaComprobante, Recibo, Me.mParaMoraTMovBanco, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, "", "WEBANTICIPOS FACTURADOS")

                    Else
                        Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Me.mVisaCfbcotmov, "", Me.mVisaComprobante, Recibo, Me.mParaMoraTMovBanco, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, "", "WEBANTICIPOS")
    ...
    Private Sub TotalPagosaCuentaOtrasFormas()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If Total <> 0 Then
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("RECI_COBR")) Then
                    ' esta anulado 
                    Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Recibo, Me.mParaMoraTMovBanco, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, "", "WEBANTICIPOS FACTURADOS")
                Else
                    Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Recibo, Me.mParaMoraTMovBanco, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, "", "WEBANTICIPOS")
                End If
    ...
    Private Sub DetallePagosaCuentaVisas()
        ...
        Dim ReseCodi As Integer
        Dim ReseAnci As Integer
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If IsDBNull(Me.DbLeeHotel.mDbLector("RESE_CODI")) = False Then
                ReseCodi = Me.DbLeeHotel.mDbLector("RESE_CODI")
            Else
                ReseCodi = ""
            End If

            If IsDBNull(Me.DbLeeHotel.mDbLector("RESE_ANCI")) = False Then
                ReseAnci = Me.DbLeeHotel.mDbLector("RESE_ANCI")
            Else
                ReseAnci = ""
            End If

            If IsDBNull(Me.DbLeeHotel.mDbLector("CCEX_CODI")) = False Then
                CcexCodi = Me.DbLeeHotel.mDbLector("CCEX_CODI")
            Else
                CcexCodi = ""
            End If
            ...
            If Total <> 0 Then
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("RECI_COBR")) Then
                    ' esta anulado 
                    Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Recibo, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")
                Else
                    Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Recibo, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, TipoDoc, "WEBANTICIPOS")
                End If

            End If


            If IsDBNull(Recibo) = False Then
                Dim aux() As String = Recibo.Split("/")
                Me.GrabaRecibo(aux(0), aux(1), CStr(Me.DbLeeHotel.mDbLector("SECC_CODI")), Total, 0, ReseCodi, ReseAnci, CcexCodi)
            End If
    ...
    Private Sub TotalPagosaCuentaVisasComision()
        Try
            ...
            Dim DimDepartamento As String
            Dim DimNaturaleza As String
            Dim DocALiquidar As String

            Dim AuxStrLocal As String
            ...
            SQL = "SELECT TNHT_MOVI.MOVI_VDEB TOTAL,TNHT_CACR.CACR_DESC TARJETA,NVL(TNHT_CACR.CACR_CTBA,'0') CUENTA,NVL(TNHT_CACR.CACR_CTB2,'0') CUENTAGASTO,TNHT_CACR.CACR_COMI,TNHT_CACR.CACR_CTB3 AS DIMNATURALEZA,TNHT_MOVI.SECC_CODI,TNHT_CACR.CACR_CTB4 AS DIMDEPARTAMENTO "
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("DIMNATURALEZA")) Then
                    DimNaturaleza = ""
                Else
                    DimNaturaleza = CStr(Me.DbLeeHotel.mDbLector("DIMNATURALEZA"))
                End If
                ...
                If Total <> 0 Then
                    ...
                    If TotalComision <> 0 Then
                        ...
                        Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), Me.mIndicadorHaber, "COMISION ANTICIPOS " & CType(Me.DbLeeHotel.mDbLector("CACR_COMI"), String) & " %  " & CType(Me.DbLeeHotel.mDbLector("TARJETA"), String), TotalComision, "NO", "", AuxStrLocal, "SI", "", Me.Multidiario, Me.mParaSecc_AntNh, Recibo, Me.mParaMoraTMovBanco, "", "", Me.mParaMoraDimenHotel, "", DocALiquidar, "", "WEBCOBROS")
                        ...
                        Me.InsertaOracleMorasol("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTAGASTO"), String), Me.mIndicadorDebe, "COMISION ANTICIPOS " & CType(Me.DbLeeHotel.mDbLector("CACR_COMI"), String) & " %  " & CType(Me.DbLeeHotel.mDbLector("TARJETA"), String), TotalComision, "NO", "", AuxStrLocal, "SI", "", Me.Multidiario, Me.mParaSecc_AntNh, Recibo, Me.mParaMoraTMovCuenta, DimNaturaleza, DimDepartamento, Me.mParaMoraDimenHotel, "", DocALiquidar, TipoDoc, "WEBCOBROS")
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If CType(Me.DbLeeHotel.mDbLector("ESTADO"), String) = "2" And IsDBNull(Me.DbLeeHotel.mDbLector("ENTI_CODI")) = False Then
                    Cuenta = CStr(Me.DbLeeHotel.mDbLector("ENTI_CODI"))
    ...
    Private Sub NFacturasSalidaTotalFActuraNuevo()
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                Cuenta = GetNewHotel.DevuelveCodigoEntidadyCCexdeFacturaTito(CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")))
    ...
    Private Sub NFacturasSalidaDetalleIgic()
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                CuentaCliente = GetNewHotel.DevuelveCodigoEntidadyCCexdeFacturaTito(CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")))
                ' Dni = GetNewHotel.DevuelveDniCifContabledeFactura(CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")))
...
#Region "ASIENTO-51"
    ...
    Private Sub NotasDeCreditoEntidadCredito()
        ...
        SQL += " NCRE_TITU, NCRE_DAEM,TNHT_NCRE.ENTI_CODI CUENTA ,NVL(ENTI_NUCO,0) CIF,NVL(ENTI_NOME,'?') AS NOMBRE,NCRE_ANUL AS ANULADA"
    ...
    Private Sub NotasDeCreditoEntidadCreditoDetalleIgic()
        ...
        SQL += " CUENTA ,TNHT_NCRE.ENTI_CODI CUENTACLIENTE ,NVL(ENTI_NUCO,0) CIF ,NVL(TNHT_TIVA.TIVA_CCVL,'?') AS X,NCRE_ANUL AS ANULADA FROM TNHT_NCRE,TNHT_ENTI,TNHT_TIVA,VNHT_NIVA"
        ...
        SQL += " AND TNHT_NCRE.NCRE_DAEM = " & "'" & Me.mFecha & "' "
        SQL += " GROUP BY TNHT_NCRE.SEFA_CODI,TNHT_NCRE.NCRE_CODI,NCRE_VALO,TIVA_PERC,TNHT_NCRE.NCRE_DAEM,TIVA_CTB1,ENTI_CODI,"
    ...
    Private Sub NotasDeCreditoEntidadCreditoDetalleIgic2()
        ...
        SQL += " CUENTA ,TNHT_NCRE.ENTI_CODI CUENTACLIENTE ,NVL(ENTI_NUCO,0) CIF ,NVL(TNHT_TIVA.TIVA_CCVL,'?') AS X,NCRE_ANUL AS ANULADA "
        SQL += ",TIVA_CTB1 IVANEGOCIO,TIVA_CCVL IVAPRODUCTO "
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Reserva = GetReservasdeUnaNotaDeCredito(CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE2")))
            CuentaCliente = Me.DbLeeHotel.mDbLector("CUENTACLIENTE")
...
#Region "ASIENTO-35"
    ...
    Private Sub FacturasContadoTotalVisas()
        ...
        SQL += " ,TNHT_FACT.RESE_CODI,TNHT_FACT.RESE_ANCI "
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If IsDBNull(Me.DbLeeHotel.mDbLector("RESE_CODI")) = False Then
                CodigoExterno = Me.DbLeeHotel.mDbLector("RESE_CODI") & Me.DbLeeHotel.mDbLector("RESE_ANCI")
            Else
                CodigoExterno = ""
            End If
    ...
    Private Sub FacturasContadoTotaLOtrasFormas()
        ...
        SQL = ""
        SQL = "Select TNHT_MOVI.MOVI_VDEB TOTAL,TNHT_FORE.FORE_DESC TIPO,NVL(TNHT_FORE.FORE_CTB1,'0') CUENTA,TNHT_FACT.SEFA_CODI AS SERIE,TNHT_FACT.FACT_CODI AS NUMERO,NVL(TNHT_FACT.FACT_TITU,' ') AS TITULAR,NVL(FAAN_CODI,'0') AS FAAN_CODI ,TNHT_FACT.RESE_CODI,TNHT_FACT.RESE_ANCI  FROM " & Me.mStrHayHistorico & " TNHT_MOVI,TNHT_FORE,TNHT_FACT,TNHT_FAMO WHERE"
    ...
    Private Sub FacturasCancelaciondeAnticiposHTito(vFactura As Integer, vSerie As String, vSeccion As String, vFaanCodi As String)
        ...
        While Me.DbLeeHotelAux.mDbLector.Read
            ...
            If Total <> 0 Then
                ...
                Cuenta = GetNewHotel.DevuelveCodigoEntidadyCCexdeFacturaTito(CInt(Me.DbLeeHotelAux.mDbLector("NUMERO")), CStr(Me.DbLeeHotelAux.mDbLector("SERIE")))
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If Saldo <> 0 Then
                    ...
                    Cuenta = GetNewHotel.DevuelveCodigoEntidadyCCexdeFacturaTito(CInt(Me.DbLeeHotel.mDbLector("FACT_CODI")), CStr(Me.DbLeeHotel.mDbLector("SEFA_CODI")))
    ...
    Private Sub SaldoAnticiposFacturasPorSeccion()
        Try
            ...
            Dim Saldo As Double
            Dim DevolucionRemanente As Double

            Dim ImporteDevuelto As Double
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                ' Ver si la factra tuvo devoluciones automativas
                SQL = "SELECT      "
                SQL += "        NVL( SUM (TNHT_MOVI.MOVI_VDEB),0) * -1 TOTAL, TNHT_FACT.FACT_CODI AS NUMERO, "
                SQL += "         TNHT_FACT.SEFA_CODI SERIE "
                SQL += "    FROM " & Me.mStrHayHistorico & " TNHT_MOVI, TNHT_FACT, TNHT_RESE, TNHT_FAMO "
                SQL += "   WHERE TNHT_FAMO.FACT_CODI = TNHT_FACT.FACT_CODI "
                SQL += "     AND TNHT_FAMO.SEFA_CODI = TNHT_FACT.SEFA_CODI "
                ...
                ImporteDevuelto = Me.DbLeeHotelAux2.EjecutaSqlScalar(SQL)
                ...
                DevolucionRemanente = ImporteDevuelto
                ...
                While Me.DbLeeHotelAux.mDbLector.Read
                    ...
                    If DevolucionRemanente > 0 Then

                        ' Calcula Saldo a contabilizar
                        If Saldo > DevolucionRemanente Then
                            Saldo = Saldo - DevolucionRemanente
                        Else
                            Saldo = Saldo
                        End If

                        ' Actualiza Remanente de devolucion
                        If Saldo > DevolucionRemanente Then
                            DevolucionRemanente = 0
                        Else
                            DevolucionRemanente = DevolucionRemanente - Saldo
                        End If
    ...
    Private Sub SaldoAnticiposFacturasPorSeccionDetalladoAuxiliar(vValor As Double, vSeccion As String, vFNumero As Integer, vFSerie As String, vFaanCodi As String)
        Try
            Dim Cuenta As String
            Dim CuentaCliente As String
            Dim TipoDoc As String
            Dim DocLiquidar
            Dim ImporteAnticipoaSaldar As Double
            Dim ValorApunteDevolucion As Double
            Dim AnadeApunte22 As Boolean = False
            ...
            ' ANTICIPOS(debitos) no automaticos EN FACTURA
            SQL = "SELECT       "
            SQL += "         TNHT_MOVI.MOVI_VDEB  TOTAL  "
            SQL += ", SUBSTR(FNHT_MOVI_RECI(TNHT_MOVI.MOVI_CODI,TNHT_MOVI.MOVI_DARE,TNHT_MOVI.MOVI_TIMO),1,20) AS RECIBO "
            SQL += ",TNHT_MOVI.RESE_CODI,TNHT_MOVI.RESE_ANCI "
            SQL += "    FROM " & Me.mStrHayHistorico & " TNHT_MOVI, TNHT_FACT, TNHT_RESE, TNHT_FAMO "
            SQL += "   WHERE TNHT_FAMO.FACT_CODI = TNHT_FACT.FACT_CODI "
            SQL += "     AND TNHT_FAMO.SEFA_CODI = TNHT_FACT.SEFA_CODI "
            ...
            SQL += "     AND TNHT_MOVI.MOVI_AUTO = '0' "
            ' NO ANULADOS
            SQL += "     AND TNHT_MOVI.MOVI_ANUL = '0' "
            SQL += "     AND TNHT_MOVI.SECC_CODI = '" & vSeccion & "'"
            SQL += " AND TNHT_FACT.FACT_CODI = " & vFNumero
            SQL += " AND TNHT_FACT.SEFA_CODI = '" & vFSerie & "'"
            ...
            While Me.DbLeeHotelAux2.mDbLector.Read
                ...
                If IsDBNull(Me.DbLeeHotelAux2.mDbLector("RESE_CODI")) = False Then
                    Reserva = Me.DbLeeHotelAux2.mDbLector("RESE_CODI") & "/" & Me.DbLeeHotelAux2.mDbLector("RESE_ANCI")
                Else
                    Reserva = ""
                End If
                ...
                If vValor > Me.DbLeeHotelAux2.mDbLector("TOTAL") Then
                    ' recibo se salda entero >
                    DebugText = "Saldo " & vValor
                    AnadeApunte22 = False
                    ImporteAnticipoaSaldar = Me.DbLeeHotelAux2.mDbLector("TOTAL")
                    ValorApunteDevolucion = 0
                    vValor = vValor - CDbl(Me.DbLeeHotelAux2.mDbLector("TOTAL"))

                ElseIf vValor < Me.DbLeeHotelAux2.mDbLector("TOTAL") Then
                    ' se devuelve de este recibo
                    DebugText = "Saldo " & vValor
                    AnadeApunte22 = True
                    ValorApunteDevolucion = (Me.DbLeeHotelAux2.mDbLector("TOTAL") - vValor) * -1
                    ImporteAnticipoaSaldar = vValor
                    vValor = 0
                ...
                If ImporteAnticipoaSaldar <> 0 Then
                    Linea = Linea + 1
                    If vFaanCodi = "" Then
                        ImporteAnticipoaSaldar = ImporteAnticipoaSaldar
                        ValorApunteDevolucion = ValorApunteDevolucion
                    Else
                        ImporteAnticipoaSaldar = ImporteAnticipoaSaldar * -1
                        ValorApunteDevolucion = ValorApunteDevolucion * -1
                    End If
                    ...
                    DocLiquidar = CStr(Me.DbLeeHotelAux2.mDbLector("RECIBO"))

                    Me.mTipoAsiento = "DEBE"
                    Me.InsertaOracleMorasol("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, "Saldo de " & GetNewHotel.DevuelveNombreSeccion(vSeccion) & " al Facturar " & vFNumero & "/" & vFSerie, ImporteAnticipoaSaldar, "NO", "", "", "SI", "", CStr(vFNumero), vFSerie, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")
                    ...
                    DocLiquidar = Me.DbLeeHotel.mDbLector("FACTURA")
                    Me.mTipoAsiento = "HABER"
                    Me.InsertaOracleMorasol("AC", 35, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CuentaCliente, Me.mIndicadorHaber, "Saldo de " & GetNewHotel.DevuelveNombreSeccion(vSeccion) & " al Facturar " & vFNumero & "/" & vFSerie, ImporteAnticipoaSaldar, "NO", "", "", "SI", "", CStr(vFNumero), vFSerie, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")

                    ' la pata del haber asiento 22 se hace aqui por tener el numero de recibo del que se devuelve (doc a liquidar)

                    If ValorApunteDevolucion <> 0 Then
                        Linea = Linea + 1
                        DocLiquidar = CStr(Me.DbLeeHotelAux2.mDbLector("RECIBO"))
                        Me.InsertaOracleMorasol("AC", 22, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaber, "Devol. en Factura " & GetNewHotel.DevuelveNombreSeccion(vSeccion), ValorApunteDevolucion, "NO", "", "", "SI", "", Me.Multidiario, vSeccion, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBCOBROS")
                    End If
                End If
    ...
    End Sub
    Private Sub SaldoAnticiposFacturasPorSeccionDetallado()
        Try
            '    Dim Total As Double
            Dim Cuenta As String

            Dim Saldo As Double
            Dim SaldoAuxiliar As Double
            Dim DevolucionRemanente As Double
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                '' MANTRA DE ESTE ASIENTO 

                ''  SI SE HA DEVUELTO EN LA FACTURA O SEA SI 
                ''
                ''  ImporteDevuelto  > 0 
                ''      
                ''          SE HACEN TANTOS APUNTES 35 COMO RECIBOS SOPORTEN LA DEVOLUCION    438   A 430
                ''          SE HACEN TANTOS APUNTES 22 COMO RECIBOS SOPORTEN LA DEVOLUCION    438   A 570 
                ''
                ''

                If ImporteDevuelto > 0 Then
                    Dim TEXTO As String
                    TEXTO = "Si existe Devolucion automatica " & vbCrLf & vbCrLf

                    TEXTO += " SE HACEN TANTOS APUNTES 35 COMO RECIBOS SOPORTEN LA DEVOLUCION    438   A 430" & vbCrLf
                    TEXTO += " SE HACEN TANTOS APUNTES 22 COMO RECIBOS SOPORTEN LA DEVOLUCION    438   A 570" & vbCrLf & vbCrLf

                    TEXTO += "falta terminar y  asunto crear tabla TH_RECI_LOG con las detracciones por FECHA de cada recibo " & vbCrLf & vbCrLf

                    TEXTO += "las detracciones por fecha se insertan cuando se usan y se borran y suma su imoprte al saldo del recibo cada dia al inicio del proceso " & vbCrLf


                    TEXTO += "Revisar toda la rutina de este MSGBOX y ... el asiento de devoluciones con recibo 21  " & vbCrLf
                    MsgBox(TEXTO)
                End If
                ...
                ' PDTE2:
                '' POSIBLE SALIDA AQUI A RUTINA ACTUALIZA RECIBOS , EM VEZ DE LEER LOS ANTICIPOS DEBAJO , LA RUTINA DEBERA DE LEER RECIBOS
                MsgBox("POSIBLE SALIDA AQUI A RUTINA ACTUALIZA RECIBOS , EM VEZ DE LEER LOS ANTICIPOS DEBAJO , LA RUTINA DEBERA DE LEER RECIBOS")


                ' Se lean las secciones de los debitos no automaticos de la factra 
                ...
                While Me.DbLeeHotelAux.mDbLector.Read
                    ...
                    If DevolucionRemanente > 0 Then
                        ...
                        Else
                            ...
                            TipoDoc = ""
                        End If
                        '    Me.ActualizaRecibo(CInt(Me.DbLeeHotel.mDbLector("NUMERO")) & "/" & CStr(Me.DbLeeHotel.mDbLector("SERIE")), ReseCodi, ReseAnci, CcexCodi, CStr(Me.DbLeeHotelAux.mDbLector("SECC_CODI")), DevolucionRemanente, Cuenta, "Devolución En Fact.", TipoDoc, 22)
                        ...
                        ' Calcula Saldo a contabilizar
                        ''   si saldo es mayor que DevolucionRemanente es que uso PArte del annticipo  si es menor se DEVuelve en asiento 22
                        If Saldo > DevolucionRemanente Then

                            Saldo = Saldo - DevolucionRemanente
                            ' 20181116 
                            '' sale ha hacer los 35 por la parte que consumio de debito de la seccion
                            If IsDBNull(Me.DbLeeHotel.mDbLector("FAAN_CODI")) Then
                                FaanCodi = ""
                            Else
                                FaanCodi = Me.DbLeeHotel.mDbLector("FAAN_CODI")
                            End If
                            Me.SaldoAnticiposFacturasPorSeccionDetalladoAuxiliar(Saldo, CStr(Me.DbLeeHotelAux.mDbLector("SECC_CODI")), CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")), FaanCodi)
                            ' fin 
                    ...
                    '' SALIR AQUI A RUTINA AUXILIAR CON EL DEPARTAMENTO Y EL PROPOSITO A SALDAR QUE ES SALDO
    ...
    Private Sub SaldoAnticiposFacturasPorSeccionHTito()
        Try
            ...
            Dim ImporteDevuelto As Double
            Dim AnticiposRecibidos As Double
            Dim AnticiposUsados As Double
            Dim DevolucionesConRecibo
            Dim TipoDoc As String
            Dim ReseCodi As Integer
            Dim ReseAnci As Integer
            Dim CcexCodi As String
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If ImporteDevuelto > 0 Then
                    ...
                    MsgBox("falta pasar a esta rutina el valor de una cuenta contable , y una seccion ")
                    Cuenta = ""
                    '   TipoDoc = Me.mParaMoraTDocAnticipo
                    TipoDoc = ""


                    '' sale ha hacer las patas del 22 
                    Me.ActualizaReciboPorDevolucionEnRecibo("", ReseCodi, ReseAnci, CcexCodi, "", ImporteDevuelto, Cuenta, "Devolución En Fact.", TipoDoc, 22, CInt(Me.DbLeeHotel.mDbLector("NUMERO")) & "/" & CStr(Me.DbLeeHotel.mDbLector("SERIE")), "WEBANTICIPOS FACTURADOS")
                ...
                AnticiposRecibidos = CDbl(Me.DbLeeHotelAux.EjecutaSqlScalar(SQL))
                ...
                Me.mTextDebug.Text = "Calculando Saldo Anticipos(*) Facturas de Salida (contado)" & CInt(Me.DbLeeHotel.mDbLector("NUMERO")) & "/" & CStr(Me.DbLeeHotel.mDbLector("SERIE"))
                Me.mTextDebug.Update()


                DevolucionesConRecibo = CDbl(Me.DbLeeHotelAux.EjecutaSqlScalar(SQL)) * -1


                AnticiposUsados = AnticiposRecibidos - (ImporteDevuelto + DevolucionesConRecibo)


                If AnticiposUsados <> 0 Then
                    '' sale a hacer los 35
                    ...
                    If FaanCodi.Length = 0 Then
                        ActualizaReciboPorEmisionEnFactura(ReseCodi, ReseAnci, CcexCodi, AnticiposUsados, "Valor de Anticipo/Dep Facrurado", 35, CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")))

                    Else
                        ActualizaReciboPorEmisionEnFacturaAnulada(ReseCodi, ReseAnci, CcexCodi, AnticiposUsados, "Valor de Anticipo/Dep Facrurado", 35, CInt(Me.DbLeeHotel.mDbLector("NUMERO")), CStr(Me.DbLeeHotel.mDbLector("SERIE")), Me.DbLeeHotel.mDbLector("FAAN_CODI"), Me.DbLeeHotel.mDbLector("FAAN_SEFA"))
    ...
    Private Function SaldoAnticiposalFacturarSeccion(ByVal vFactura As Integer, ByVal vSerie As String, ByVal vSeccion As String) As Double
        Try
            ...
            Recibido = CDbl(Me.DbLeeHotelAux.EjecutaSqlScalar(SQL))
    ...
    Private Function SaldoAnticiposalFacturarSeccionTest(ByVal vFactura As Integer, ByVal vSerie As String, ByVal vSeccion As String) As Double
        Try
    ...
    Private Sub FacturasContadoTotalVisasComision()
        Try
            ...
            SQL += " ,NVL(CACR_CTB3,'0') AS DIMNATURALEZA  "
            SQL += " ,NVL(CACR_CTB4,'0') AS DIMDEPARTAMENTO  "
            ...
            SQL += ",SUBSTR(FNHT_MOVI_RECI(TNHT_MOVI.MOVI_CODI,TNHT_MOVI.MOVI_DARE,TNHT_MOVI.MOVI_TIMO),1,20),TNHT_CACR.CACR_CTB3,TNHT_CACR.CACR_CTB4,TNHT_FACT.RESE_CODI,TNHT_FACT.RESE_ANCI "
...
#Region "ASIENTO-21 DEVOLUCIONES "
    ...
    Private Sub TotalDevolucionesOtrasFormas()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.mTipoAsiento = "DEBE"
            ' 20181207
            Me.InsertaOracleMorasol("AC", 21, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, Total, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), Recibo, Me.mParaMoraTMovBanco, "", "", Me.mParaMoraDimenHotel, Reserva, DocALiquidar, "", "WEBANTICIPOS FACTURADOS")
    ...
    Private Sub DetalleDevolucionesVisas()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Else
                ...
                Me.mAuxStr = ""
                '20180809
                Me.ActualizaReciboPorDevolucionEnRecibo(Recibo, ReseCodi, ReseAnci, CcexCodi, CStr(Me.DbLeeHotel.mDbLector("SECC_CODI")), CDbl(Me.DbLeeHotel.mDbLector("TOTAL")) * -1, Cuenta, Texto, TipoDoc, 21, "", "WEBANTICIPOS FACTURADOS")
    ...
    Private Sub DetalleDevolucionesOtrasFormas()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            ' se hace en la rutina GrabaRecibo
...
#Region "ASIENTO-22 DEVOLUCIONES EN FACTURA "
    ...
    Private Sub DetalleDevolucionesVisasFacturado()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            ' SE HACE MAS ABAJO EN SALDODE ANTICIPOS 
...
#Region "METODOS PUBLICOS"
    Public Sub Procesar()
        Try
            ...
            If Me.DbLeeHotel.EstadoConexion = ConnectionState.Open Then
                ...
                Else
                    Me.SaldoAnticiposFacturasPorSeccionHTito()
    ...
    Private Function LocaLizareciboMayorAnticipo(vFactura As Integer, vSerie As String) As String
        ...
        End Try
    End Function
    Private Function LocaLizareciboMayorSeccion(vFactura As Integer, vSerie As String, vSeccCodi As String) As String
        Try
...
#Region "RECIBOS"
    ...
    Private Sub GrabaRecibo(vReciCodi As Integer, vReciAnci As Integer, vSeccion As String, vRecivalo As Double, vReciSaldo As Double, vReseCodi As Integer, vReseAnci As Integer, vCcexCodi As String)
        Try
            ...
            SQL = "SELECT NVL(COUNT(*),0) AS CONTROL  FROM TH_RECI "

            SQL += " WHERE  EMPGRUPO_COD = '" & Me.mEmpGrupoCod & "'"
            SQL += " AND EMP_COD = '" & Me.mEmpCod & "'"
            SQL += " AND EMP_NUM = " & Me.mEmpNum

            SQL += " AND RECI_CODI = " & vReciCodi
            SQL += " And RECI_ANCI = " & vReciAnci


            If Me.DbLeeCentral.EjecutaSqlScalar(SQL) = "1" Then
                SQL = "DELETE  TH_RECI "
                SQL += " WHERE  EMPGRUPO_COD = '" & Me.mEmpGrupoCod & "'"
                SQL += " AND EMP_COD = '" & Me.mEmpCod & "'"
                SQL += " AND EMP_NUM = " & Me.mEmpNum
            ...
            SQL = "INSERT INTO TH_RECI (EMPGRUPO_COD,EMP_COD,EMP_NUM,RECI_CODI,RECI_ANCI,RECI_DATR,SECC_CODI,RECI_VALO,RECI_SALDO,RESE_CODI,RESE_ANCI,CCEX_CODI) VALUES"
            SQL += "(" & "'" & Me.mEmpGrupoCod & "','" & Me.mEmpCod & "'," & Me.mEmpNum
            SQL += "," & vReciCodi
            SQL += "," & vReciAnci
            SQL += ",'" & Format(Me.mFecha, "dd/MM/yyyy") & "'"
            ...
            If vCcexCodi.Length = 0 Then
                SQL += "," & vReseCodi & "," & vReseAnci & "," & "''" & ")"
            Else
                SQL += "," & "''" & "," & "''" & "," & "'" & vCcexCodi & "'" & ")"
            End If
    ...
    Private Sub InicializaRecibos()
        Try
            SQL = "SELECT RECI_CODI,RECI_ANCI,RECI_KEY,RECI_IMPO FROM TH_RECI_MOVI "
            SQL += " WHERE  EMPGRUPO_COD = '" & Me.mEmpGrupoCod & "'"
            SQL += " AND EMP_COD = '" & Me.mEmpCod & "'"
            SQL += " AND EMP_NUM = " & Me.mEmpNum

            SQL += " AND  RECI_DATM = '" & Format(Me.mFecha, "dd/MM/yyyy") & "'"
            ...
            While Me.DbLeeCentral.mDbLector.Read
                SQL = "UPDATE TH_RECI SET RECI_SALDO = RECI_SALDO + " & Math.Abs(CDec(Me.DbLeeCentral.mDbLector.Item("RECI_IMPO")))

                SQL += " WHERE  EMPGRUPO_COD = '" & Me.mEmpGrupoCod & "'"
                SQL += " AND EMP_COD = '" & Me.mEmpCod & "'"
                SQL += " AND EMP_NUM = " & Me.mEmpNum
                SQL += " AND RECI_CODI = " & Me.DbLeeCentral.mDbLector.Item("RECI_CODI")
                ...
                SQL += " AND RECI_CODI = " & Me.DbLeeCentral.mDbLector.Item("RECI_CODI")
                SQL += " AND RECI_ANCI = " & Me.DbLeeCentral.mDbLector.Item("RECI_ANCI")
                SQL += " AND RECI_KEY = " & Me.DbLeeCentral.mDbLector.Item("RECI_KEY")
                Me.DbGrabaCentral.EjecutaSql(SQL)
                If Me.DbGrabaCentral.StrError <> "" Then
                    Me.DbGrabaCentral.CancelaTransaccion()
                    Me.DbLeeCentral.mDbLector.Close()
    ...
    Private Sub ActualizaReciboPorDevolucionEnRecibo(vRecibo As String, vReseCodi As Integer, vReseAnci As Integer, vCcexCodi As String, vSeccion As String, vSaldar As Double, vCuenta As String, vDesc As String, vTipoDoc As String, vTipoAsiento As Integer, vFactura As String, vWebServiceName As String)
        Try
            ...
            If vRecibo.Length > 0 Then
                Recibo = vRecibo.Split("/")
            Else
                Recibo = "/".Split("/")
            End If


            If vFactura.Length > 0 Then
                Factura = vFactura.Split("/")
            Else
                Factura = "/".Split("/")
            End If
            ...
            SQL = "SELECT SUM(RECI_SALDO)  FROM TH_RECI "
            SQL += " WHERE  EMPGRUPO_COD = '" & Me.mEmpGrupoCod & "'"
            SQL += " AND EMP_COD = '" & Me.mEmpCod & "'"
            SQL += " AND EMP_NUM = " & Me.mEmpNum
            SQL += " AND RECI_SALDO > 0 "
            ...
            Me.DbGrabaCentral2.IniciaTransaccion()


            Me.DbLeeCentral.TraerLector(SQL)
            While Me.DbLeeCentral.mDbLector.Read

                If vSaldar > Me.DbLeeCentral.mDbLector("SALDO") Then
                    ' recibo se salda entero >
                    SaldoDelRecibo = 0
                    ValorApunte = CDbl(Me.DbLeeCentral.mDbLector("SALDO"))
                    vSaldar = vSaldar - CDbl(Me.DbLeeCentral.mDbLector("SALDO"))
                ElseIf vSaldar < Me.DbLeeCentral.mDbLector("SALDO") Then
                    ' se devuelve parte  de este recibo
                    SaldoDelRecibo = CDbl(Me.DbLeeCentral.mDbLector("SALDO")) - vSaldar
                    ValorApunte = vSaldar
                    vSaldar = 0
                ElseIf vSaldar = Me.DbLeeCentral.mDbLector("SALDO") Then
                    ' recibo se salda entero
                ...
                SQL += " AND EMP_COD = '" & Me.mEmpCod & "'"
                SQL += " AND EMP_NUM = " & Me.mEmpNum
                SQL += " AND RECI_CODI = " & CInt(Me.DbLeeCentral.mDbLector("RECI_CODI"))
                SQL += " AND RECI_ANCI = " & CInt(Me.DbLeeCentral.mDbLector("RECI_ANCI"))

                Me.DbGrabaCentral2.EjecutaSql(SQL)
                ...
                SQL = "INSERT INTO TH_RECI_MOVI ( EMPGRUPO_COD,EMP_COD,EMP_NUM,RECI_CODI,RECI_ANCI,RECI_KEY,RECI_DATM,RECI_IMPO,RECI_CODI2,RECI_ANCI2,FACT_CODI,SEFA_CODI,RECI_OBSE) VALUES"
                SQL += "(" & "'" & Me.mEmpGrupoCod & "','" & Me.mEmpCod & "'," & Me.mEmpNum
                ...
                Else
                    SQL += "," & CInt(Me.DbLeeCentral.mDbLector("RECI_CODI")) & "," & CInt(Me.DbLeeCentral.mDbLector("RECI_ANCI"))
                End If


                If vFactura.Length > 0 Then
                    SQL += "," & Factura(0) & ",'" & Factura(1)
                Else
                    SQL += "," & "NULL" & ",'" & "NULL"
                End If


                SQL += "','" & "Recibo De Devolución" & "')"

                Me.DbGrabaCentral2.EjecutaSql(SQL)



                ' la cuenta la determiona siempre la seccion del recibo en el que se encuentra saldo

                If Me.mParaDistingeAnticiposDeDepositos = True And CStr(Me.DbLeeCentral.mDbLector("SECC_CODI")) = Me.mParaSecc_DepNh Then
                    vCuenta = Me.mParaCta4b & Me.mParaSufijoDepositos
                    '    TipoDoc = Me.mParaMoraTDocDeposito
                Else
                    vCuenta = Me.mCtaPagosACuenta & Me.mParaSufijoAnticipos
                    '   TipoDoc = Me.mParaMoraTDocAnticipo
                End If


                If vSeccion.Length = 0 Then
                    vSeccion = CStr(Me.DbLeeCentral.mDbLector("SECC_CODI"))
                End If

                DocAliquidar = CStr(Me.DbLeeCentral.mDbLector("RECI_CODI")) & "/" & CStr(Me.DbLeeCentral.mDbLector("RECI_ANCI"))

                Me.mTipoAsiento = "HABER"
                '20181207
                Me.InsertaOracleMorasol("AC", vTipoAsiento, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, vCuenta, Me.mIndicadorHaber, "" & vDesc, ValorApunte * -1, "NO", "", Me.mAuxStr, "SI", "", Me.Multidiario, vSeccion, vRecibo, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, vReseCodi & "/" & vReseAnci, DocAliquidar, vTipoDoc, vWebServiceName)
            ...
            End While
            Me.DbGrabaCentral2.ConfirmaTransaccion()
            Me.DbLeeCentral.mDbLector.Close()


        Catch ex As Exception
            Me.DbGrabaCentral2.CancelaTransaccion()
            MsgBox(ex.Message)
        End Try
    End Sub
    Private Sub ActualizaReciboPorEmisionEnFactura(vReseCodi As Integer, vReseAnci As Integer, vCcexCodi As String, vSaldar As Double, vDesc As String, vTipoAsiento As Integer, vFNumero As Integer, vFSerie As String)
        Try
            ...
            ' con independencia de la seccion
            SQL += " ORDER BY RECI_ANCI, RECI_CODI"
            ...
            While Me.DbLeeCentral.mDbLector.Read
                ...
                SQL = "INSERT INTO TH_RECI_MOVI ( EMPGRUPO_COD,EMP_COD,EMP_NUM,RECI_CODI,RECI_ANCI,RECI_KEY,RECI_DATM,RECI_IMPO,FACT_CODI,SEFA_CODI,RECI_OBSE) VALUES"
                SQL += "(" & "'" & Me.mEmpGrupoCod & "','" & Me.mEmpCod & "'," & Me.mEmpNum
                SQL += "," & CInt(Me.DbLeeCentral.mDbLector("RECI_CODI"))
                SQL += "," & CInt(Me.DbLeeCentral.mDbLector("RECI_ANCI"))
                ...
                SQL += "," & ValorApunte * -1
                SQL += "," & vFNumero & ",'" & vFSerie & "','" & "Recibo Facturado" & "')"
                ...
                If Me.mParaDistingeAnticiposDeDepositos = True And CStr(Me.DbLeeCentral.mDbLector("SECC_CODI")) = Me.mParaSecc_DepNh Then
                    Texto = "(Depósito)  " & DocLiquidar & " Facturado"
                Else
                    Texto = "(Anticipo)  " & DocLiquidar & " Facturado"
                End If



                Me.mTipoAsiento = "DEBE"
                Me.InsertaOracleMorasol("AC", 36, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, ValorApunte, "NO", "", "", "SI", "", CStr(vFNumero), vFSerie, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")
                ...
                Me.mTipoAsiento = "HABER"
                Me.InsertaOracleMorasol("AC", 36, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CuentaCliente, Me.mIndicadorHaber, Texto, ValorApunte, "NO", "", "", "SI", "", CStr(vFNumero), vFSerie, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")
    ...
    Private Sub ActualizaReciboPorEmisionEnFacturaAnulada(vReseCodi As Integer, vReseAnci As Integer, vCcexCodi As String, vSaldar As Double, vDesc As String, vTipoAsiento As Integer, vFNumero As Integer, vFSerie As String, vFanNumero As Integer, vFanSerie As String)
        Try
            ...
            SQL = "SELECT "
            SQL += "    TH_RECI.RECI_CODI, "
            SQL += "    TH_RECI.RECI_ANCI, "
            SQL += "    TH_RECI.SECC_CODI "
            SQL += "FROM "
            SQL += "    TH_RECI,TH_RECI_MOVI "
            SQL += "    WHERE   "
            SQL += "TH_RECI.EMPGRUPO_COD = TH_RECI_MOVI.EMPGRUPO_COD "
            SQL += "      AND TH_RECI.EMP_COD = TH_RECI_MOVI.EMP_COD "
            SQL += "      AND TH_RECI.EMP_NUM = TH_RECI_MOVI.EMP_NUM "
            SQL += "      AND TH_RECI.RECI_CODI = TH_RECI_MOVI.RECI_CODI "
            SQL += "      AND TH_RECI.RECI_ANCI = TH_RECI_MOVI.RECI_ANCI "

            SQL += " AND TH_RECI.EMPGRUPO_COD = '" & Me.mEmpGrupoCod & "'"
            SQL += " AND TH_RECI.EMP_COD = '" & Me.mEmpCod & "'"
            SQL += " AND TH_RECI.EMP_NUM = " & Me.mEmpNum
            ...
            While Me.DbLeeCentral.mDbLector.Read
                ...
                SQL += "," & vSaldar * -1
                SQL += "," & vFNumero & ",'" & vFSerie & "','Retorno de Saldo por Factura Anulada'" & ")"
                ...
                Me.mTipoAsiento = "DEBE"
                Me.InsertaOracleMorasol("AC", 36, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, Texto, vSaldar, "NO", "", "", "SI", "", CStr(vFNumero), vFSerie, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")
                ...
                DocLiquidar = vFNumero & "/" & vFSerie
                Me.mTipoAsiento = "HABER"
                Me.InsertaOracleMorasol("AC", 36, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CuentaCliente, Me.mIndicadorHaber, Texto, vSaldar, "NO", "", "", "SI", "", CStr(vFNumero), vFSerie, CStr(vFNumero) & "/" & vFSerie, Me.mParaMoraTMovCliente, "", "", Me.mParaMoraDimenHotel, Reserva, DocLiquidar, TipoDoc, "WEBANTICIPOS FACTURADOS")
