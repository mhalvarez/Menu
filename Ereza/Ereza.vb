...
#Region "METODOS VARIOS"
    ...
    Private Sub BorraRegistros()
        Try
            ...
            If CType(Me.DbLeeCentral.EjecutaSqlScalar(SQL), Integer) > 0 Then
                MsgBox("Ya existen Movimientos de Integración para esta Fecha " & Me.mFecha, MsgBoxStyle.Information, "Atención")
            End If
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String, _
                                      ByVal vCfatocab_Refer As Integer, ByVal vLinea As Integer _
                                      , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double, _
                                        ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String, ByVal vImprimir As String, ByVal vNumeroFactura As String, ByVal vSerieFactura As String)
        ...
        Try
            ...
            SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
            SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
            SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_FACTURA_NUMERO,ASNT_FACTURA_SERIE) values ('"
            SQL += vTipo & "','"
            SQL += vEmpGrupoCod & "','"
            SQL += vEmpCod & "','"
            SQL += vCefejerc_Cod & "','"
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("ENTI_CODI")) = False Then
                    ...
                    ' valida variacion entre nojmbre de entidad y titular de la factura 
                    SQL = "SELECT NVL(ENTI_NOME,'?') NOMBRE FROM TNHT_ENTI WHERE ENTI_CODI = '" & CType(Me.DbLeeHotel.mDbLector("ENTI_CODI"), String) & "'"

                    Entidad = Me.DbLeeHotelAux.EjecutaSqlScalar(SQL)
                    If Entidad <> CType(DbLeeHotel.mDbLector("TITULAR"), String) Then
                        Texto = "Variación de Código de Entidad de la Factura y Titular" & vbCrLf & vbCrLf
                        Texto += "Factura  = " & CType(DbLeeHotel.mDbLector("DESCRIPCION"), String) & vbCrLf & vbCrLf
                        Texto += " Entidad de la Factura  = " & Entidad & vbCrLf & vbCrLf
                        Texto += " Titular de la Factura  = " & CType(DbLeeHotel.mDbLector("TITULAR"), String)
                        '  MsgBox(Texto, MsgBoxStyle.Exclamation, "Atención")
                    End If
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("FAAN_CODI")) = True Then
                    ' FACTURAS NORMALES
                    Me.mTipoAsiento = "HABER"
                    Me.InsertaOracle("FV", 3, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Me.mCtaManoCorriente, Me.mIndicadorHaber, "SU FACTURA " & CType(Me.DbLeeHotel.mDbLector("DESCRIPCION"), String), TotalFactura, "NO", Dni, Titular, "SI", "DOCUMENTO", 0, CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String), 0, "")

                Else
                    ' FACTURAS RECTIFICATIVAS
                    Me.mTipoAsiento = "DEBE"
                    Me.InsertaOracle("FV", 3, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Me.mCtaManoCorriente, Me.mIndicadorDebe, "SU RECTIFICATIVA " & CType(Me.DbLeeHotel.mDbLector("DESCRIPCION"), String), TotalFactura * -1, "NO", Dni, Titular, "SI", "DOCUMENTO", 0, CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String), 0, "")
        ...
        Try
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If CType(Me.DbLeeHotel.mDbLector("ESTADO"), String) = "2" And IsDBNull(Me.DbLeeHotel.mDbLector("ENTI_CODI")) = False Then
                    ...
                    If Entidad <> CType(DbLeeHotel.mDbLector("TITULAR"), String) Then
                        Texto = "Variación de Código de Entidad de la Factura y Titular" & vbCrLf & vbCrLf
                        Texto += "Factura  = " & CType(DbLeeHotel.mDbLector("NUMERO"), String) & "/" & CType(DbLeeHotel.mDbLector("SERIE"), String) & vbCrLf & vbCrLf
                        Texto += " Entidad de la Factura  = " & Entidad & vbCrLf & vbCrLf
                        Texto += " Titular de la Factura  = " & CType(DbLeeHotel.mDbLector("TITULAR"), String)
                        '       MsgBox(Texto, MsgBoxStyle.Exclamation, "Atención Contrapartida de Igic")
                    End If
                ...
                Else
                    ' FACTURAS RECTIFICATIVAS
                    Me.mTipoAsiento = "DEBE"
                    Me.InsertaOracle("AC", 3, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), Me.mIndicadorDebe, DescripcionAsiento, TotalIva * -1, "NO", Me.mClientesContadoCif, "Contrapartida : " & CuentaContraPartida, "SI", Me.mParaTextoIva, TotalBase * -1, CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String), CType(Me.DbLeeHotel.mDbLector("FAIV_TAXA"), Double), CuentaContraPartida)
                End If
...
#Region "ASIENTO-51"
    Private Sub NotasDeCreditoTotalLiquido()
        ...
        Try
            ...
            SQL = "SELECT VH_NIVA.NCRE_DOCU,VH_NIVA.SEDO_CODI,(SUM(MOVI_VLIQ)*-1 ) TOTAL ,TNHT_NCRE.NCRE_DAEM ,NVL(NCRE_TITU,'?') AS NOMBRE "
            ...
            SQL += " GROUP BY VH_NIVA.NCRE_DOCU,VH_NIVA.SEDO_CODI,TNHT_NCRE.NCRE_DAEM,NCRE_TITU "
            SQL += " ORDER BY VH_NIVA.NCRE_DOCU  ASC"
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If Total <> 0 Then
                    Me.mTipoAsiento = "DEBE"
                    Me.InsertaOracle("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Me.mCtaManoCorriente, Me.mIndicadorDebe, "SU ABONO " & CType(Me.DbLeeHotel.mDbLector("NCRE_DOCU"), String) & "/" & CType(Me.DbLeeHotel.mDbLector("SEDO_CODI"), String), Total, "SI", "", CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "SI", CType(Me.DbLeeHotel.mDbLector("NCRE_DOCU"), String), CType(Me.DbLeeHotel.mDbLector("SEDO_CODI"), String))
                End If
            ...
            'ANULADAS
            SQL = "SELECT VH_NIVA.NCRE_DOCU,VH_NIVA.SEDO_CODI,(SUM(MOVI_VLIQ) ) TOTAL ,NCRE_DAAN ,NVL(NCRE_TITU,'?') AS NOMBRE "
            SQL += "FROM VH_NIVA,TNHT_NCRE "
            SQL += "WHERE "
            SQL += "  VH_NIVA.NCRE_CODI = TNHT_NCRE.NCRE_CODI "
            SQL += " AND VH_NIVA.SEFA_CODI = TNHT_NCRE.SEFA_CODI "
            SQL += "AND TNHT_NCRE.NCRE_DAAN = " & "'" & Me.mFecha & "' "
            SQL += " GROUP BY VH_NIVA.NCRE_DOCU,VH_NIVA.SEDO_CODI,NCRE_DAAN,NCRE_TITU "
            SQL += " ORDER BY VH_NIVA.NCRE_DOCU  ASC"
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If Total <> 0 Then
                    Me.mTipoAsiento = "HABER"
                    Me.InsertaOracle("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Me.mCtaManoCorriente, Me.mIndicadorHaber, "SU ABONO ANULADO " & CType(Me.DbLeeHotel.mDbLector("NCRE_DOCU"), String) & "/" & CType(Me.DbLeeHotel.mDbLector("SEDO_CODI"), String), Total, "SI", "", CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "SI", CType(Me.DbLeeHotel.mDbLector("NCRE_DOCU"), String), CType(Me.DbLeeHotel.mDbLector("SEDO_CODI"), String))
                End If
    ...
    Private Sub NotasDeCreditoCliente()
        ...
        SQL = "SELECT"
        SQL += " TNHT_NCRE.SEDO_CODI AS SERIE, TNHT_NCRE.NCRE_DOCU AS NUMERO,TNHT_NCRE.NCRE_DOCU||'/'||TNHT_NCRE.SEDO_CODI FACTURA,(NCRE_VALO) TOTAL, "
        SQL += " NCRE_TITU, NCRE_DAEM,NVL(NCRE_TITU,'?') AS NOMBRE "
        SQL += " ,ENTI_CODI,CCEX_CODI"
        SQL += " FROM TNHT_NCRE "
        SQL += " WHERE  "
        SQL += " TNHT_NCRE.NCRE_DAEM = " & "'" & Me.mFecha & "' "
        SQL += " ORDER BY TNHT_NCRE.NCRE_DOCU ASC "
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If Cuenta = "0" Then
                Cuenta = InputBox("Digite cuenta contable de Cliente  para " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String) & " " & CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "Atención")
            End If
            ...
            Me.mTipoAsiento = "HABER"
            Me.InsertaOracle("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorHaberFac, "SU ABONO " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), Total, "NO", Dni, CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "SI", CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String))
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            Me.mTipoAsiento = "DEBE"
            Me.InsertaOracle("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebeFac, "SU ABONO ANULADO " & CType(Me.DbLeeHotel.mDbLector("FACTURA"), String), Total, "NO", Dni, CType(Me.DbLeeHotel.mDbLector("NOMBRE"), String), "SI", CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String))
    ...
    Private Sub NotasDeCreditoCreditoDetalleIgic()
        ...
        SQL = "SELECT"
        SQL += " TNHT_NCRE.SEDO_CODI AS SERIE , TNHT_NCRE.NCRE_DOCU AS NUMERO,(NCRE_VALO * -1)TOTAL,SUM(MOVI_VLIQ) BASE,SUM(VIVA) IGIC, '"
        ...
        SQL += " AND TNHT_NCRE.NCRE_DAEM = " & "'" & Me.mFecha & "' "
        SQL += " GROUP BY TNHT_NCRE.SEDO_CODI,TNHT_NCRE.NCRE_DOCU,NCRE_VALO,TIVA_PERC,TNHT_NCRE.NCRE_DAEM,TIVA_CTB1,"
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If CuentaContraPartida = "0" Then
                CuentaContraPartida = InputBox("Digite cuenta contable de Cliente para " & DescripcionAsiento, "Atención")
            End If
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            DescripcionAsiento = Me.mParaTextoIva & " " & Me.DbLeeHotel.mDbLector("NUMERO") & "/" & Me.DbLeeHotel.mDbLector("SERIE") & " Anulado"
            ...
            Me.InsertaOracle("AC", 51, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, CType(Me.DbLeeHotel.mDbLector("CUENTA"), String), Me.mIndicadorHaber, DescripcionAsiento, TotalIva, "NO", Me.mClientesContadoCif, "Contrapartida : " & CuentaContraPartida, "SI", Me.mParaTextoIva, TotalBase, CType(Me.DbLeeHotel.mDbLector("NUMERO"), String), CType(Me.DbLeeHotel.mDbLector("SERIE"), String), CType(Me.DbLeeHotel.mDbLector("TIPO"), Double), CuentaContraPartida)
