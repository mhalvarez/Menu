    ...
    Private Sub ProcesaContanet()
        ...
        Try
            ...
            If Me.DbLee.mDbLector.HasRows Then
                Me.m_EXCN = New NSOLE5.Enlace
                Me.m_EXCN.AbrirEmpresa(Me.m_EmpresaContanet)
                Me.m_EXCN_ANIO = Me.m_EXCN.Año


                If CInt(Format(Me.mFecha, "yy")) <> CInt(Me.m_EXCN.Año) Then
                    Me.m_EXCN.CerrarEmpresa()
                    Me.DbLee.mDbLector.Close()
                    MsgBox("Ejercicio Contable (" & Me.m_EXCN.Año & ") y Año (" & Format(Me.mFecha, "yyyy") & ") de  la Fecha Procesada NO Coinciden ",, "Atención")
                    Exit Sub
                End If
            ...
            While Me.DbLee.mDbLector.Read
                ...
                Try
                    Me.m_EXCN.Fecha = "10/08/" & Me.m_EXCN_ANIO
                    Me.m_EXCN.Número = ""
                    '   Me.m_EXCN.AñadirApunte Cuenta:="4300000988", Descripción:="Factura Excel " & x, Tipo:=1, Importe:=5200, Diario:=1
                    '  Me.m_EXCN.AñadirApunte Cuenta:="7000000000", Descripción:="Factura Excel " & x, Tipo:=2, Importe:=5000, Diario:=1
                    ' Me.m_EXCN.AñadirApunte Cuenta:="4770000000", Descripción:="IVA Fra. Excel " & x, Tipo:=2, Importe:=200, Diario:=1
                    'Me.m_EXCN.AñadirApunte Cuenta:="5720000001", Descripción:="Pago Fra. Excel " & x, Tipo:=1, Importe:=5200, Diario:=1
                    'Me.m_EXCN.AñadirApunte Cuenta:="4300000988", Descripción:="Pago Fra. Excel " & x, Tipo:=2, Importe:=5200, Diario:=1

                    'Me.m_EXCN.AñadirIVA CuentaClienteProveedor:="4300000988", CuentaIVA:="4770000000", Factura:=x, FechaFactura:=Año & "0715", TipoIva:="04", SRTC:="R", Base:=5000, Total:=5200

                    'Me.m_EXCN.AñadirCartera FechaVencimiento:=Año & "0901", Cuenta:="4300000988", Cartera:="01", Notas:="Ole Test Fra." & x, Importe:=5000
                    'Me.m_EXCN.AñadirCartera FechaVencimiento:=Año & "1001", Cuenta:="4300000988", Cartera:="01", Notas:="Ole Test Fra." & x, Importe:=5000
                    'Me.m_EXCN.AñadirCartera FechaVencimiento:=Año & "1101", Cuenta:="4300000988", Cartera:="01", Notas:="Ole Test Fra." & x, Importe:=5000

                    'Me.m_EXCN.GrabarAsiento()
