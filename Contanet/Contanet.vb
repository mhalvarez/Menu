...
Public Class Contanet

    Private EXCN As New NSOLE5.Enlace
...
#Region "METODOS Privados"
    ...
    Private Sub InsertaOracle(ByVal vTipo As String, ByVal vAsiento As Integer, ByVal vEmpGrupoCod As String, ByVal vEmpCod As String, ByVal vCefejerc_Cod As String,
                                    ...
                                    , ByVal vCfcta_Cod As String, ByVal vCfcptos_Cod As String, ByVal vAmpcpto As String, ByVal vImonep As Double,
                                      ByVal vAjuste As String, ByVal vCif As String, ByVal vNombre As String,
                                      ByVal vImprimir As String, ByVal vAuxiliarString As String,
                                      ByVal vMultiDiario As Boolean, ByVal vDptoNh As String, ByVal vCcexCodi As String, ByVal vNada As String, ByVal vReseCodi As String, ByVal vReseAnci As String, ByVal vAlojCodi As String, vRecibo As String, vNada2 As String)
        ...
        Try
            ...
            If IsNothing(vCcexCodi) = False Then
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_AUXILIAR_STRING,ASNT_DPTO_CODI,ASNT_DPTO_DESC,ASNT_CCEX_CODI,ASNT_RECIBO ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste
                SQL += "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vAuxiliarString & "','" & vDptoNh & "','" & Me.mAuxStr & "','" & vCcexCodi & "','" & vRecibo & "')"
            ...
            ElseIf IsNothing(vReseCodi) = False Then
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_AUXILIAR_STRING,ASNT_DPTO_CODI,ASNT_DPTO_DESC,ASNT_CCEX_CODI,ASNT_RESE_CODI,ASNT_RESE_ANCI,ASNT_ALOJ_CODI,ASNT_RECIBO ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste
                SQL += "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vAuxiliarString & "','" & vDptoNh & "','" & Me.mAuxStr & "','" & vCcexCodi & "'," & vReseCodi & "," & vReseAnci & ",'" & vAlojCodi & "','" & vRecibo & "')"
            ...
            Else
                SQL = "INSERT INTO TH_ASNT(ASNT_TIPO_REGISTRO,ASNT_EMPGRUPO_COD,ASNT_EMP_COD,ASNT_CFEJERC_COD,ASNT_CFATODIARI_COD,ASNT_CFATOCAB_REFER,"
                SQL += "ASNT_LINEA,ASNT_CFCTA_COD,ASNT_CFCPTOS_COD,ASNT_AMPCPTO,ASNT_I_MONEMP,ASNT_CONCIL_SN,ASNT_F_ATOCAB,ASNT_F_VALOR,ASNT_NOMBRE,"
                SQL += "ASNT_DEBE,ASNT_HABER,ASNT_AJUSTAR,ASNT_CIF,ASNT_IMPRIMIR,ASNT_EMP_NUM,ASNT_AUXILIAR_STRING,ASNT_DPTO_CODI,ASNT_DPTO_DESC,ASNT_RECIBO ) values ('"
                SQL += vTipo & "','"
                SQL += vEmpGrupoCod & "','"
                SQL += vEmpCod & "','"
                SQL += vCefejerc_Cod & "','"
                ...
                SQL += Format(Me.mFecha, "dd/MM/yyyy") & "','"
                SQL += vNombre.Replace("'", "''") & "'," & Me.mDebe & "," & Me.mHbaber & ",'" & vAjuste
                SQL += "','" & vCif & "','" & vImprimir & "'," & Me.mEmpNum & ",'" & vAuxiliarString & "','" & vDptoNh & "','" & Me.mAuxStr & "','" & vRecibo & "')"
...
#Region "ASIENTO-2 PAGOS A CUENTA"
    Private Sub TotalPagosaCuentaVisas()
        Try
            ...
            SQL = SQL & "FNHT_MOVI_RECI(TNHT_MOVI.MOVI_CODI,TNHT_MOVI.MOVI_DARE,TNHT_MOVI.MOVI_TIMO) RECI_COBR,NVL(MOVI_NUDO,' ') MOVI_NUDO,NVL(MOVI_DESC,' ') MOVI_DESC,NVL(SECC_CODI,'?') AS SECC_CODI"
            ...
            While Me.DbLeeHotel.mDbLector.Read
                ...
                If IsDBNull(Me.DbLeeHotel.mDbLector("RECI_COBR")) = False Then
                    Recibo = CStr(Me.DbLeeHotel.mDbLector("RECI_COBR"))
                Else
                    Recibo = ""
                End If
                ...
                If Total <> 0 Then
                    Linea = Linea + 1
                    Me.mTipoAsiento = "DEBE"
                    Me.InsertaOracle("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, CType(Me.DbLeeHotel.mDbLector("TARJETA"), String) & " " & CType(Me.DbLeeHotel.mDbLector("MOVI_DESC"), String), Total, "NO", "", "", "SI", "ANTICIPO RECIBIDO", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), CcExCodi, "", ReseCodi, ReseAnci, AlojCodi, Recibo, "")
    ...
    Private Sub TotalPagosaCuentaOtrasFormas()
        ...
        While Me.DbLeeHotel.mDbLector.Read
            ...
            If Total <> 0 Then
                Linea = Linea + 1
                Me.mTipoAsiento = "DEBE"
                Me.InsertaOracle("AC", 2, Me.mEmpGrupoCod, Me.mEmpCod, CType(Now.Year, String), 1, Linea, Cuenta, Me.mIndicadorDebe, CType(Me.DbLeeHotel.mDbLector("TIPO"), String) & " " & CType(Me.DbLeeHotel.mDbLector("MOVI_DESC"), String), Total, "NO", "", "", "SI", "ANTICIPO RECIBIDO", Me.Multidiario, CType(Me.DbLeeHotel.mDbLector("SECC_CODI"), String), CcExCodi, "", ReseCodi, ReseAnci, AlojCodi, Recibo, "")
